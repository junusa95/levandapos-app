function initSparkline() {
    $(".sparkline").each(function () {
        ...
        $(".bh_visitors").sparkline("html", { type: "bar", height: "42px", barColor: "#a27ce6", barWidth: 5 }),
        $(".bh_visits").sparkline("html", { type: "bar", height: "42px", barColor: "#3eacff", barWidth: 5 }),
        $(".bh_chats").sparkline("html", { type: "bar", height: "42px", barColor: "#50d38a", barWidth: 5 });
}
...
function CustomJs() {
    $(".main-menu").metisMenu(),
        $(".cwidget-scroll").slimScroll({ height: "263px", wheelStep: 10, touchScrollStep: 50, color: "#efefef", size: "2px", borderRadius: "3px", alwaysVisible: !1, position: "right" }),
    ...
    ($.fn.clickToggle = function (e, i) {
        return this.each(function () {
            ...
            $(this).bind("click", function () {
                return t ? ((t = !1), i.apply(this, arguments)) : ((t = !0), e.apply(this, arguments));
            });
        });
    });
...
//     (t.async = !0), (t.src = "https://embed.tawk.to/5c6d4867f324050cfe342c69/default"), (t.charset = "UTF-8"), t.setAttribute("crossorigin", "*"), e.parentNode.insertBefore(t, e);
// })();
