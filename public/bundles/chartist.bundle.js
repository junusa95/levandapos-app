!(function (t, e) {
    ...
    return (
        (function (u, g, p) {
            "use strict";
            (p.namespaces = { svg: "http://www.w3.org/2000/svg", xmlns: "http://www.w3.org/2000/xmlns/", xhtml: "http://www.w3.org/1999/xhtml", xlink: "http://www.w3.org/1999/xlink", ct: "http://gionkunz.github.com/chartist-js/ct" }),
                (p.noop = function (t) {
                    return t;
                }),
                ...
                (p.extend = function (t) {
                    var e, i, n;
                    for (t = t || {}, e = 1; e < arguments.length; e++) for (var a in (i = arguments[e])) "object" != typeof (n = i[a]) || null === n || n instanceof Array ? (t[a] = n) : (t[a] = p.extend(t[a], n));
                    return t;
                }),
                ...
                (p.serialize = function (t) {
                    return null == t
                        ? t
                        : ("number" == typeof t ? (t = "" + t) : "object" == typeof t && (t = JSON.stringify({ data: t })),
                ...
                (p.createSvg = function (e, t, i, n) {
                    e = document.getElementById('clear-error'); // this is forced to clear error
                    var a;
                    return (
                        (t = t || "100%"),
                        (i = i || "100%"),
                        ...
                        ((a = new p.Svg("svg").attr({ width: t, height: i }).addClass(n))._node.style.width = t),
                ...
                (p.normalizeData = function (t, e, i) {
                    var n,
                        a = { raw: t, normalized: {} };
                    return (
                        (a.normalized.series = p.getDataArray({ series: t.series || [] }, e, i)),
                        ...
                        Array.prototype.push.apply(
                            a.normalized.labels,
                            p.times(Math.max(0, n - a.normalized.labels.length)).map(function () {
                                return "";
                            })
                        ),
                    ...
                    return t.series.map(function t(e) {
                        ...
                        if (!p.isDataHoleValue(e)) {
                            if (n) {
                                var i = {};
                                return (
                                    "string" == typeof n ? (i[n] = p.getNumberOrUndefined(e)) : (i.y = p.getNumberOrUndefined(e)),
                                    (i.x = e.hasOwnProperty("x") ? p.getNumberOrUndefined(e.x) : i.x),
                                    (i.y = e.hasOwnProperty("y") ? p.getNumberOrUndefined(e.y) : i.y),
                                    i
                                );
                            }
                ...
                (p.normalizePadding = function (t, e) {
                    return (
                        ...
                        "number" == typeof t
                            ...
                            : { top: "number" == typeof t.top ? t.top : e, right: "number" == typeof t.right ? t.right : e, bottom: "number" == typeof t.bottom ? t.bottom : e, left: "number" == typeof t.left ? t.left : e }
                    );
                }),
                ...
                (p.getAvailableHeight = function (t, e) {
                    return Math.max((p.quantity(e.height).value || t.height()) - (e.chartPadding.top + e.chartPadding.bottom) - e.axisX.offset, 0);
                }),
                (p.getHighLow = function (t, e, a) {
                    var r = { high: void 0 === (e = p.extend({}, e, a ? e["axis" + a.toUpperCase()] : {})).high ? -Number.MAX_VALUE : +e.high, low: void 0 === e.low ? Number.MAX_VALUE : +e.low },
                        o = void 0 === e.high,
                        s = void 0 === e.low;
                    return (
                        (o || s) &&
                            (function t(e) {
                                if (void 0 !== e)
                                    if (e instanceof Array) for (var i = 0; i < e.length; i++) t(e[i]);
                                        ...
                                        var n = a ? +e[a] : +e;
                                        o && n > r.high && (r.high = n), s && n < r.low && (r.low = n);
                                    }
                            })(t),
                        (e.referenceValue || 0 === e.referenceValue) && ((r.high = Math.max(e.referenceValue, r.high)), (r.low = Math.min(e.referenceValue, r.low))),
                        r.high <= r.low && (0 === r.low ? (r.high = 1) : r.low < 0 ? (r.high = 0) : (0 < r.high || (r.high = 1), (r.low = 0))),
                        r
                    );
                }),
                ...
                (p.getMultiValue = function (t, e) {
                    return p.isMultiValue(t) ? p.getNumberOrUndefined(t[e || "y"]) : p.getNumberOrUndefined(t);
                }),
                (p.rho = function (t) {
                    function i(t, e) {
                    ...
                    var n,
                        ...
                        r = 2;
                    if (t % 2 == 0) return 2;
                    for (; (a = e(a) % t), (r = e(e(r)) % t), 1 === (n = i(Math.abs(a - r), t)); );
                    return n;
                }),
                (p.getBounds = function (t, e, i, n) {
                    ...
                    if (n && p.projectLength(t, 1, u) >= i) u.step = 1;
                        ...
                        for (;;) {
                            ...
                            if (1e3 < l++) throw new Error("Exceeded maximum number of iterations while optimizing scale step!");
                        }
                    var h = 2221e-19;
                    for (u.step = Math.max(u.step, h), o = u.min, s = u.max; o + u.step <= u.low; ) o = a(o, u.step);
                ...
                (p.createChartRect = function (t, e, i) {
                    ...
                    (o = Math.max(o, a + l.left + l.right)), (s = Math.max(s, r + l.top + l.bottom));
                    var u = {
                        padding: l,
                        width: function () {
                    ...
                    return (
                        n
                            ? ("start" === e.axisX.position ? ((u.y2 = l.top + r), (u.y1 = Math.max(s - l.bottom, u.y2 + 1))) : ((u.y2 = l.top), (u.y1 = Math.max(s - l.bottom - r, u.y2 + 1))),
                              "start" === e.axisY.position ? ((u.x1 = l.left + a), (u.x2 = Math.max(o - l.right, u.x1 + 1))) : ((u.x1 = l.left), (u.x2 = Math.max(o - l.right - a, u.x1 + 1))))
                            : ((u.x1 = l.left), (u.x2 = Math.max(o - l.right, u.x1 + 1)), (u.y2 = l.top), (u.y1 = Math.max(s - l.bottom, u.y2 + 1))),
                        u
                    );
                }),
                (p.createGrid = function (t, e, i, n, a, r, o, s) {
                    var l = {};
                    (l[i.units.pos + "1"] = t), (l[i.units.pos + "2"] = t), (l[i.counterUnits.pos + "1"] = n), (l[i.counterUnits.pos + "2"] = n + a);
                    var u = r.elem("line", l, o.join(" "));
                    s.emit("draw", p.extend({ type: "grid", axis: i, index: e, group: r, element: u }, l));
                }),
                (p.createGridBackground = function (t, e, i, n) {
                    var a = t.elem("rect", { x: e.x1, y: e.y2, width: e.width(), height: e.height() }, i, !0);
                    n.emit("draw", { type: "gridBackground", group: t, element: a });
                }),
                (p.createLabel = function (t, e, i, n, a, r, o, s, l, u, d) {
                    var c,
                        h = {};
                    if (((h[a.units.pos] = t + o[a.units.pos]), (h[a.counterUnits.pos] = o[a.counterUnits.pos]), (h[a.units.len] = e), (h[a.counterUnits.len] = Math.max(0, r - 10)), u)) {
                        var f = g.createElement("span");
                        (f.className = l.join(" ")),
                            f.setAttribute("xmlns", p.namespaces.xhtml),
                            (f.innerText = n[i]),
                            (f.style[a.units.len] = Math.round(h[a.units.len]) + "px"),
                            (f.style[a.counterUnits.len] = Math.round(h[a.counterUnits.len]) + "px"),
                            (c = s.foreignObject(f, p.extend({ style: "overflow: visible;" }, h)));
                    } else c = s.elem("text", h, l.join(" ")).text(n[i]);
                    d.emit("draw", p.extend({ type: "label", axis: a, index: i, group: s, element: c, text: n[i] }, h));
                }),
                ...
                (p.optionsProvider = function (t, i, n) {
                    function e(t) {
                        ...
                        n && t && n.emit("optionsChanged", { previousOptions: e, currentOptions: a });
                    }
                    var a,
                        r,
                        o = p.extend({}, t),
                        s = [];
                    if (!u.matchMedia) throw "window.matchMedia not found! Make sure you're using a polyfill.";
                    if (i)
                        for (r = 0; r < i.length; r++) {
            ...
            (p.Interpolation = {}),
                (p.Interpolation.none = function (l) {
                    return (
                        ...
                        function (t, e) {
                            for (var i = new p.Svg.Path(), n = !0, a = 0; a < t.length; a += 2) {
                                var r = t[a],
                                    o = t[a + 1],
                                    s = e[a / 2];
                                void 0 !== p.getMultiValue(s.value) ? (n ? i.move(r, o, !1, s) : i.line(r, o, !1, s), (n = !1)) : l.fillHoles || (n = !0);
                            }
                            return i;
                        }
                    );
                ...
                (p.Interpolation.simple = function (c) {
                    ...
                    return function (t, e) {
                        for (var i, n, a, r = new p.Svg.Path(), o = 0; o < t.length; o += 2) {
                            var s = t[o],
                                l = t[o + 1],
                                u = (s - i) * h,
                                d = e[o / 2];
                            void 0 !== d.value ? (void 0 === a ? r.move(s, l, !1, d) : r.curve(i + u, n, s - u, l, s, l, !1, d), (i = s), (n = l), (a = d)) : c.fillHoles || (i = s = a = void 0);
                        }
                        return r;
                    };
                }),
                (p.Interpolation.cardinal = function (u) {
                    ...
                    return function e(t, i) {
                        ...
                        if (n.length) {
                            ...
                            if (((t = n[0].pathCoordinates), (i = n[0].valueData), t.length <= 4)) return p.Interpolation.none()(t, i);
                            for (var r = new p.Svg.Path().move(t[0], t[1], !1, i[0]), o = 0, s = t.length; o < s - 2; o += 2) {
                                var l = [
                                    { x: +t[o - 2], y: +t[o - 1] },
                                    { x: +t[o], y: +t[o + 1] },
                                    { x: +t[o + 2], y: +t[o + 3] },
                                ...
                                s - 4 === o ? (l[3] = l[2]) : o || (l[0] = { x: +t[o], y: +t[o + 1] }),
                                    r.curve(
                ...
                (p.Interpolation.monotoneCubic = function (g) {
                    return (
                        ...
                        function e(t, i) {
                            var n = p.splitIntoSegments(t, i, { fillHoles: g.fillHoles, increasingX: !0 });
                            if (n.length) {
                                if (1 < n.length) {
                                    var a = [];
                                    return (
                                ...
                                var r,
                                    ...
                                    h = [],
                                    f = [];
                                for (r = 0; r < u; r++) (s[r] = t[2 * r]), (l[r] = t[2 * r + 1]);
                                for (r = 0; r < u - 1; r++) (h[r] = l[r + 1] - l[r]), (f[r] = s[r + 1] - s[r]), (c[r] = h[r] / f[r]);
                                for (d[0] = c[0], d[u - 1] = c[u - 2], r = 1; r < u - 1; r++)
                                    0 === c[r] || 0 === c[r - 1] || 0 < c[r - 1] != 0 < c[r]
                                        ? (d[r] = 0)
                                        : ((d[r] = (3 * (f[r - 1] + f[r])) / ((2 * f[r] + f[r - 1]) / c[r - 1] + (f[r] + 2 * f[r - 1]) / c[r])), isFinite(d[r]) || (d[r] = 0));
                                for (o = new p.Svg.Path().move(s[0], l[0], !1, i[0]), r = 0; r < u - 1; r++)
                                    o.curve(s[r] + f[r] / 3, l[r] + (d[r] * f[r]) / 3, s[r + 1] - f[r] / 3, l[r + 1] - (d[r + 1] * f[r]) / 3, s[r + 1], l[r + 1], !1, i[r + 1]);
                                return o;
                            }
                            return p.Interpolation.none()([]);
                        }
                        ...
                        function (t, e) {
                            for (var i, n, a, r = new p.Svg.Path(), o = 0; o < t.length; o += 2) {
                                var s = t[o],
                                    l = t[o + 1],
                                    u = e[o / 2];
                                void 0 !== u.value ? (void 0 === a ? r.move(s, l, !1, u) : (d.postpone ? r.line(s, n, !1, a) : r.line(i, l, !1, u), r.line(s, l, !1, u)), (i = s), (n = l), (a = u)) : d.fillHoles || (i = n = a = void 0);
                            }
                            return r;
                        }
                    );
            ...
            n.EventEmitter = function () {
                ...
                return {
                    ...
                    removeEventHandler: function (t, e) {
                        n[t] && (e ? (n[t].splice(n[t].indexOf(e), 1), 0 === n[t].length && delete n[t]) : delete n[t]);
                    },
                    emit: function (e, i) {
                        n[e] &&
            ...
            r.Class = {
                extend: function (t, e) {
                    ...
                    var a = function () {
                        ...
                        return (t = this === r ? Object.create(n) : this), e.apply(t, Array.prototype.slice.call(arguments, 0)), t;
                    };
                    ...
                    return (
                        t.splice(1, t.length - 1).forEach(function (e) {
                            Object.getOwnPropertyNames(e).forEach(function (t) {
                                delete i[t], Object.defineProperty(i, t, Object.getOwnPropertyDescriptor(e, t));
                            });
                        }),
                        i
                    );
            ...
            o.Base = o.Class.extend({
                constructor: function (t, e, i, n, a) {
                    (this.container = o.querySelector(t)),
                        ...
                        (this.supportsAnimations = o.Svg.isSupported("AnimationEventsAttribute")),
                        ...
                        (this.initializeTimeoutId = setTimeout(
                            function () {
                                r.addEventListener("resize", this.resizeListener),
                                    (this.optionsProvider = o.optionsProvider(this.options, this.responsiveOptions, this.eventEmitter)),
                ...
                update: function (t, e, i) {
                    return (
                        t && ((this.data = t || {}), (this.data.labels = this.data.labels || []), (this.data.series = this.data.series || []), this.eventEmitter.emit("data", { type: "update", data: this.data })),
                        e &&
                            ((this.options = o.extend({}, i ? this.options : this.defaultOptions, e)),
                            this.initializeTimeoutId || (this.optionsProvider.removeMediaQueryListeners(), (this.optionsProvider = o.optionsProvider(this.options, this.responsiveOptions, this.eventEmitter)))),
                        this.initializeTimeoutId || this.createChart(this.optionsProvider.getCurrentOptions()),
                        this
                    );
                },
                detach: function () {
                    return this.initializeTimeoutId ? r.clearTimeout(this.initializeTimeoutId) : (r.removeEventListener("resize", this.resizeListener), this.optionsProvider.removeMediaQueryListeners()), this;
                },
                on: function (t, e) {
        ...
        (function (t, o, l) {
            ...
            (l.Svg = l.Class.extend({
                constructor: function (t, e, i, n, a) {
                    t instanceof Element ? (this._node = t) : ((this._node = o.createElementNS(l.namespaces.svg, t)), "svg" === t && this.attr({ "xmlns:ct": l.namespaces.ct })),
                        e && this.attr(e),
                        i && this.addClass(i),
                        n && (a && n._node.firstChild ? n._node.insertBefore(this._node, n._node.firstChild) : n._node.appendChild(this._node));
                },
                attr: function (i, t) {
                ...
                parent: function () {
                    return this._node.parentNode instanceof SVGElement ? new l.Svg(this._node.parentNode) : null;
                },
                root: function () {
                            ...
                            function (o) {
                                function e(e, t) {
                                    var i,
                                        ...
                                        a,
                                        r = {};
                                    e.easing && ((a = e.easing instanceof Array ? e.easing : l.Svg.Easing[e.easing]), delete e.easing),
                                        (e.begin = l.ensureUnit(e.begin, "ms")),
                                        (e.dur = l.ensureUnit(e.dur, "ms")),
                                        a && ((e.calcMode = "spline"), (e.keySplines = a.join(" ")), (e.keyTimes = "0;1")),
                                        t && ((e.fill = "freeze"), (r[o] = e.from), this.attr(r), (n = l.quantity(e.begin || 0).value), (e.begin = "indefinite")),
                                        (i = this.elem("animate", l.extend({ attributeName: o }, e))),
                                        t &&
                                            setTimeout(
                                                function () {
                                                    try {
                                        ...
                                        s &&
                                            i._node.addEventListener(
                                                "beginEvent",
                                                function () {
                                                    s.emit("animationBegin", { element: this, animate: i._node, params: e });
                                                }.bind(this)
                                            ),
                                        i._node.addEventListener(
                                            "endEvent",
                                            function () {
                                                s && s.emit("animationEnd", { element: this, animate: i._node, params: e }), t && ((r[o] = e.to), this.attr(r), i.remove());
                                            }.bind(this)
                                        );
                                }
                ...
                (l.Svg.isSupported = function (t) {
                    return o.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#" + t, "1.1");
                });
            (l.Svg.Easing = {
                ...
                (l.Svg.List = l.Class.extend({
                    constructor: function (t) {
                        var n = this;
                        this.svgElements = [];
                        for (var e = 0; e < t.length; e++) this.svgElements.push(new l.Svg(t[e]));
        ...
        (function (t, e, s) {
            ...
            function u(t, e, i, n, a, r) {
                var o = s.extend({ command: a ? t.toLowerCase() : t.toUpperCase() }, e, r ? { data: r } : {});
                i.splice(n, 0, o);
            }
            function a(a, r) {
            ...
            var o = { m: ["x", "y"], l: ["x", "y"], c: ["x1", "y1", "x2", "y2", "x", "y"], a: ["rx", "ry", "xAr", "lAf", "sf", "x", "y"] },
                i = { accuracy: 3 };
            (s.Svg.Path = s.Class.extend({
                constructor: function (t, e) {
                    (this.pathElements = []), (this.pos = 0), (this.close = t), (this.options = s.extend({}, i, e));
                },
                position: function (t) {
                ...
                move: function (t, e, i, n) {
                    return u("M", { x: +t, y: +e }, this.pathElements, this.pos++, i, n), this;
                },
                line: function (t, e, i, n) {
                    return u("L", { x: +t, y: +e }, this.pathElements, this.pos++, i, n), this;
                },
                curve: function (t, e, i, n, a, r, o, s) {
                    return u("C", { x1: +t, y1: +e, x2: +i, y2: +n, x: +a, y: +r }, this.pathElements, this.pos++, o, s), this;
                },
                arc: function (t, e, i, n, a, r, o, s, l) {
                    return u("A", { rx: +t, ry: +e, xAr: +i, lAf: +n, sf: +a, x: +r, y: +o }, this.pathElements, this.pos++, s, l), this;
                },
                scale: function (i, n) {
                    return (
                ...
                parse: function (t) {
                    ...
                    var i = e.map(function (n) {
                        ...
                        n = [this.pos, 0];
                    return Array.prototype.push.apply(n, i), Array.prototype.splice.apply(this.pathElements, n), (this.pos += i.length), this;
                },
                stringify: function () {
                        ...
                        this.pathElements.reduce(
                            function (t, e) {
                                var i = o[e.command.toLowerCase()].map(
                                    function (t) {
                                        return this.options.accuracy ? Math.round(e[t] * n) / n : e[t];
                                    }.bind(this)
                                );
                ...
                splitByCommand: function (e) {
                    ...
                    return (
                        this.pathElements.forEach(function (t) {
                            t.command === e.toUpperCase() && 0 !== i[i.length - 1].pathElements.length && i.push(new s.Svg.Path()), i[i.length - 1].pathElements.push(t);
                        }),
                        i
                    );
                },
                ...
                (s.Svg.Path.join = function (t, e, i) {
                    for (var n = new s.Svg.Path(e, i), a = 0; a < t.length; a++) for (var r = t[a], o = 0; o < r.pathElements.length; o++) n.pathElements.push(r.pathElements[o]);
                    return n;
                });
        })(window, document, n),
        (function (t, e, h) {
            "use strict";
            var a = { x: { pos: "x", len: "width", dir: "horizontal", rectStart: "x1", rectEnd: "x2", rectOffset: "y2" }, y: { pos: "y", len: "height", dir: "vertical", rectStart: "y2", rectEnd: "y1", rectOffset: "x1" } };
            (h.Axis = h.Class.extend({
                constructor: function (t, e, i, n) {
                    (this.units = t), (this.counterUnits = t === a.x ? a.y : a.x), (this.chartRect = e), (this.axisLength = e[t.rectEnd] - e[t.rectStart]), (this.gridOffset = e[t.rectOffset]), (this.ticks = i), (this.options = n);
                },
                                ...
                                (h.isFalseyButZero(c[e]) && "" !== c[e]) ||
                                    ("x" === this.units.pos
                                        ? ((t = this.chartRect.x1 + t),
                                          ...
                                          "start" === s.axisX.position ? (n.y = this.chartRect.padding.top + s.axisX.labelOffset.y + (o ? 5 : 20)) : (n.y = this.chartRect.y1 + s.axisX.labelOffset.y + (o ? 5 : 20)))
                                        : ((t = this.chartRect.y1 - t),
                                          (n.y = s.axisY.labelOffset.y - (o ? i : 0)),
                                          "start" === s.axisY.position ? (n.x = o ? this.chartRect.padding.left + s.axisY.labelOffset.x : this.chartRect.x1 - 10) : (n.x = this.chartRect.x2 + s.axisY.labelOffset.x + 10)),
                                    u.showGrid && h.createGrid(t, e, this, this.gridOffset, this.chartRect[this.counterUnits.len](), a, [s.classNames.grid, s.classNames[this.units.dir]], l),
                                    u.showLabel && h.createLabel(t, i, e, c, this, u.offset, n, r, [s.classNames.label, s.classNames[this.units.dir], "start" === u.position ? s.classNames[u.position] : s.classNames.end], o, l));
                        }.bind(this)
                    );
                },
        ...
        (function (t, e, r) {
            ...
            r.AutoScaleAxis = r.Axis.extend({
                constructor: function (t, e, i, n) {
                    ...
                    (this.bounds = r.getBounds(i[t.rectEnd] - i[t.rectStart], a, n.scaleMinSpace || 20, n.onlyInteger)),
                        (this.range = { min: this.bounds.min, max: this.bounds.max }),
                        r.AutoScaleAxis.super.constructor.call(this, t, i, this.bounds.values, n);
                },
                projectValue: function (t) {
                    return (this.axisLength * (+r.getMultiValue(t, this.units.pos) - this.bounds.min)) / this.bounds.range;
                },
            });
        })(window, document, n),
        (function (t, e, r) {
            ...
            r.FixedScaleAxis = r.Axis.extend({
                ...
                projectValue: function (t) {
                    return (this.axisLength * (+r.getMultiValue(t, this.units.pos) - this.range.min)) / (this.range.max - this.range.min);
                },
            });
        })(window, document, n),
        (function (t, e, r) {
        ...
        (function (t, e, m) {
            "use strict";
            var a = {
                axisX: { offset: 30, position: "end", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: m.noop, type: void 0 },
                axisY: { offset: 40, position: "start", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: m.noop, type: void 0, scaleMinSpace: 20, onlyInteger: !1 },
                width: void 0,
                height: void 0,
                showLine: !0,
                showPoint: !0,
            ...
            m.Line = m.Base.extend({
                ...
                createChart: function (d) {
                    ...
                    this.svg = m.createSvg(this.container, d.width, d.height, d.classNames.chart);
                    var h,
                        f,
                    ...
                    (h =
                        void 0 === d.axisX.type
                            ? new m.StepAxis(m.Axis.units.x, c.normalized.series, p, m.extend({}, d.axisX, { ticks: c.normalized.labels, stretch: d.fullWidth }))
                            : d.axisX.type.call(m, m.Axis.units.x, c.normalized.series, p, d.axisX)),
                        (f =
                            void 0 === d.axisY.type
                                ? new m.AutoScaleAxis(m.Axis.units.y, c.normalized.series, p, m.extend({}, d.axisY, { high: m.isNumeric(d.high) ? d.high : d.axisY.high, low: m.isNumeric(d.low) ? d.low : d.axisY.low }))
                                : d.axisY.type.call(m, m.Axis.units.y, c.normalized.series, p, d.axisY)),
                        h.createGridAndLabels(t, e, this.supportsForeignObject, d, this.eventEmitter),
                        f.createGridAndLabels(t, e, this.supportsForeignObject, d, this.eventEmitter),
                        d.showGridBackground && m.createGridBackground(t, p, d.classNames.gridBackground, this.eventEmitter),
                        c.raw.series.forEach(
                            function (n, a) {
                                var i = g.elem("g");
                                i.attr({ "ct:series-name": n.name, "ct:meta": m.serialize(n.meta) }), i.addClass([d.classNames.series, n.className || d.classNames.series + "-" + m.alphaNumerate(a)].join(" "));
                                var r = [],
                                    o = [];
                                c.normalized.series[a].forEach(
                                    function (t, e) {
                                        var i = { x: p.x1 + h.projectValue(t, e, c.normalized.series[a]), y: p.y1 - f.projectValue(t, e, c.normalized.series[a]) };
                                        r.push(i.x, i.y), o.push({ value: t, valueIndex: e, meta: m.getMetaData(n, e) });
                                    }.bind(this)
                                );
                                var t = {
                                    ...
                                    e = ("function" == typeof t.lineSmooth ? t.lineSmooth : t.lineSmooth ? m.Interpolation.monotoneCubic() : m.Interpolation.none())(r, o);
                                if (
                                    (t.showPoint &&
                                        e.pathElements.forEach(
                                            function (t) {
                                                var e = i
                                                    .elem("line", { x1: t.x, y1: t.y, x2: t.x + 0.01, y2: t.y }, d.classNames.point)
                                                    .attr({ "ct:value": [t.data.value.x, t.data.value.y].filter(m.isNumeric).join(","), "ct:meta": m.serialize(t.data.meta) });
                                    ...
                                    var s = i.elem("path", { d: e.stringify() }, d.classNames.line, !0);
                                    this.eventEmitter.emit("draw", {
                                        type: "line",
                                ...
                                if (t.showArea && f.range) {
                                    var l = Math.max(Math.min(t.areaBase, f.range.max), f.range.min),
                                    ...
                                    e.splitByCommand("M")
                                        ...
                                        .forEach(
                                            function (t) {
                                                var e = i.elem("path", { d: t.stringify() }, d.classNames.area, !0);
                                                this.eventEmitter.emit("draw", { type: "area", values: c.normalized.series[a], path: t.clone(), series: n, seriesIndex: a, axisX: h, axisY: f, chartRect: p, index: a, group: i, element: e });
                                            }.bind(this)
                                        );
                                }
                            }.bind(this)
                        ),
                        this.eventEmitter.emit("created", { bounds: f.bounds, chartRect: p, axisX: h, axisY: f, svg: this.svg, options: d });
                },
            });
        })(window, document, n),
        (function (t, e, k) {
            "use strict";
            var o = {
                axisX: { offset: 30, position: "end", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: k.noop, scaleMinSpace: 30, onlyInteger: !1 },
                axisY: { offset: 40, position: "start", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: k.noop, scaleMinSpace: 20, onlyInteger: !1 },
                width: void 0,
                height: void 0,
                high: void 0,
                low: void 0,
            ...
            k.Bar = k.Base.extend({
                ...
                createChart: function (f) {
                    var g, t;
                    f.distributeSeries
                        ? ((g = k.normalizeData(this.data, f.reverseData, f.horizontalBars ? "x" : "y")).normalized.series = g.normalized.series.map(function (t) {
                              return [t];
                          }))
                        : (g = k.normalizeData(this.data, f.reverseData, f.horizontalBars ? "x" : "y")),
                        (this.svg = k.createSvg(this.container, f.width, f.height, f.classNames.chart + (f.horizontalBars ? " " + f.classNames.horizontalBars : "")));
                    ...
                    } else t = k.getHighLow(g.normalized.series, f, f.horizontalBars ? "x" : "y");
                    (t.high = +f.high || (0 === f.high ? 0 : t.high)), (t.low = +f.low || (0 === f.low ? 0 : t.low));
                    var p,
                        r,
                        m,
                        v,
                    ...
                    (r = f.distributeSeries && f.stackBars ? g.normalized.labels.slice(0, 1) : g.normalized.labels),
                        f.horizontalBars
                            ? ((p = v =
                                  void 0 === f.axisX.type
                                      ? new k.AutoScaleAxis(k.Axis.units.x, g.normalized.series, b, k.extend({}, f.axisX, { highLow: t, referenceValue: 0 }))
                                      : f.axisX.type.call(k, k.Axis.units.x, g.normalized.series, b, k.extend({}, f.axisX, { highLow: t, referenceValue: 0 }))),
                              (m = y = void 0 === f.axisY.type ? new k.StepAxis(k.Axis.units.y, g.normalized.series, b, { ticks: r }) : f.axisY.type.call(k, k.Axis.units.y, g.normalized.series, b, f.axisY)))
                            : ((m = v = void 0 === f.axisX.type ? new k.StepAxis(k.Axis.units.x, g.normalized.series, b, { ticks: r }) : f.axisX.type.call(k, k.Axis.units.x, g.normalized.series, b, f.axisX)),
                              (p = y =
                                  void 0 === f.axisY.type
                                      ? new k.AutoScaleAxis(k.Axis.units.y, g.normalized.series, b, k.extend({}, f.axisY, { highLow: t, referenceValue: 0 }))
                                      : f.axisY.type.call(k, k.Axis.units.y, g.normalized.series, b, k.extend({}, f.axisY, { highLow: t, referenceValue: 0 }))));
                    var x = f.horizontalBars ? b.x1 + p.projectValue(0) : b.y1 - p.projectValue(0),
                        w = [];
                    m.createGridAndLabels(e, n, this.supportsForeignObject, f, this.eventEmitter),
                        p.createGridAndLabels(e, n, this.supportsForeignObject, f, this.eventEmitter),
                        f.showGridBackground && k.createGridBackground(e, b, f.classNames.gridBackground, this.eventEmitter),
                        g.raw.series.forEach(
                            function (l, u) {
                                var d,
                                    c,
                                    h = u - (g.raw.series.length - 1) / 2;
                                (d = f.distributeSeries && !f.stackBars ? m.axisLength / g.normalized.series.length / 2 : f.distributeSeries && f.stackBars ? m.axisLength / 2 : m.axisLength / g.normalized.series[u].length / 2),
                                    (c = i.elem("g")).attr({ "ct:series-name": l.name, "ct:meta": k.serialize(l.meta) }),
                                    c.addClass([f.classNames.series, l.className || f.classNames.series + "-" + k.alphaNumerate(u)].join(" ")),
                                    g.normalized.series[u].forEach(
                                        function (t, e) {
                                            var i, n, a, r;
                                            if (
                                                ((r = f.distributeSeries && !f.stackBars ? u : f.distributeSeries && f.stackBars ? 0 : e),
                                                (i = f.horizontalBars
                                                    ? { x: b.x1 + p.projectValue(t && t.x ? t.x : 0, e, g.normalized.series[u]), y: b.y1 - m.projectValue(t && t.y ? t.y : 0, r, g.normalized.series[u]) }
                                                    : { x: b.x1 + m.projectValue(t && t.x ? t.x : 0, r, g.normalized.series[u]), y: b.y1 - p.projectValue(t && t.y ? t.y : 0, e, g.normalized.series[u]) }),
                                                m instanceof k.StepAxis &&
                                                    (m.options.stretch || (i[m.units.pos] += d * (f.horizontalBars ? -1 : 1)),
                                                    (i[m.units.pos] += f.stackBars || f.distributeSeries ? 0 : h * f.seriesBarDistance * (f.horizontalBars ? -1 : 1))),
                                                (a = w[e] || x),
                                                ...
                                                (o[m.units.pos + "1"] = i[m.units.pos]),
                                                    ...
                                                    !f.stackBars || ("accumulate" !== f.stackMode && f.stackMode)
                                                        ? ((o[m.counterUnits.pos + "1"] = x), (o[m.counterUnits.pos + "2"] = i[m.counterUnits.pos]))
                                                        : ((o[m.counterUnits.pos + "1"] = a), (o[m.counterUnits.pos + "2"] = w[e])),
                                                ...
                                                (n = c.elem("line", o, f.classNames.bar).attr({ "ct:value": [t.x, t.y].filter(k.isNumeric).join(","), "ct:meta": k.serialize(s) })),
                                                    this.eventEmitter.emit("draw", k.extend({ type: "bar", value: t, index: e, meta: s, series: l, seriesIndex: u, axisX: v, axisY: y, chartRect: b, group: c, element: n }, o));
                                            }
                                        }.bind(this)
                                    );
                            }.bind(this)
                        ),
                        this.eventEmitter.emit("created", { bounds: p.bounds, chartRect: b, axisX: v, axisY: y, svg: this.svg, options: f });
                },
            });
        })(window, document, n),
        (function (t, e, D) {
            ...
            D.Pie = D.Base.extend({
                ...
                createChart: function (m) {
                    var v,
                        ...
                        k = [],
                        S = m.startAngle;
                    (this.svg = D.createSvg(this.container, m.width, m.height, m.donut ? m.classNames.chartDonut : m.classNames.chartPie)),
                    ...
                    "%" === _.unit && (_.value *= y / 100),
                        ...
                        (b = "outside" === m.labelPosition || (m.donut && !m.donutSolid) ? y : "center" === m.labelPosition ? 0 : m.donutSolid ? y - _.value / 2 : y / 2),
                        (b += m.labelOffset);
                    ...
                    w.raw.series.forEach(
                        ...
                        w.raw.series.forEach(
                            function (t, e) {
                                if (0 !== w.normalized.series[e] || !m.ignoreEmptyValues) {
                                    k[e].attr({ "ct:series-name": t.name }), k[e].addClass([m.classNames.series, t.className || m.classNames.series + "-" + D.alphaNumerate(e)].join(" "));
                                    ...
                                    var a,
                                        ...
                                        u = new D.Svg.Path(!m.donut || m.donutSolid).move(l.x, l.y).arc(y, y, 0, 180 < i - S, 0, s.x, s.y);
                                    m.donut
                                        ? m.donutSolid &&
                                          ((o = y - _.value), (a = D.polarToCartesian(M.x, M.y, o, S - (0 === e || C ? 0 : 0.2))), (r = D.polarToCartesian(M.x, M.y, o, i)), u.line(a.x, a.y), u.arc(o, o, 0, 180 < i - S, 1, r.x, r.y))
                                        : u.line(M.x, M.y);
                                    var d = m.classNames.slicePie;
                                    m.donut && ((d = m.classNames.sliceDonut), m.donutSolid && (d = m.classNames.sliceDonutSolid));
                                    var c = k[e].elem("path", { d: u.stringify() }, d);
                                    if (
                                        (c.attr({ "ct:value": w.normalized.series[e], "ct:meta": D.serialize(t.meta) }),
                                        m.donut && !m.donutSolid && (c._node.style.strokeWidth = _.value + "px"),
                                        this.eventEmitter.emit("draw", {
                                            type: "slice",
                                        ...
                                        var h, f;
                                        (h = 1 === w.raw.series.length ? { x: M.x, y: M.y } : D.polarToCartesian(M.x, M.y, b, S + (i - S) / 2)),
                                            (f = w.normalized.labels && !D.isFalseyButZero(w.normalized.labels[e]) ? w.normalized.labels[e] : w.normalized.series[e]);
                                        var g = m.labelInterpolationFnc(f, e);
                                        if (g || 0 === g) {
                                            var p = v.elem("text", { dx: h.x, dy: h.y, "text-anchor": A(M, h, m.labelDirection) }, m.classNames.label).text("" + g);
                                            this.eventEmitter.emit("draw", { type: "label", index: e, group: v, element: p, text: "" + g, x: h.x, y: h.y });
                                        }
                                    }
                                    S = i;
                                }
                        ...
                        this.eventEmitter.emit("created", { chartRect: t, svg: this.svg, options: m });
                },
    ...
    (function (e, i) {
        ...
        return (
            (function (u, v, y) {
                ...
                var t = { currency: void 0, currencyFormatCallback: void 0, tooltipOffset: { x: 0, y: -20 }, anchorToPoint: !1, appendToBody: !1, class: void 0, pointClass: "ct-point" };
                (y.plugins = y.plugins || {}),
                        ...
                        return (
                            ...
                            function (c) {
                                ...
                                function h(t) {
                                    ...
                                    if (m.appendToBody) (f.style.top = t.pageY + a + "px"), (f.style.left = t.pageX + n + "px");
                                    else {
                                        var r = l.getBoundingClientRect(),
                                            o = t.pageX - r.left - u.pageXOffset,
                                            s = t.pageY - r.top - u.pageYOffset;
                                        !0 === m.anchorToPoint && t.target.x2 && t.target.y2 && ((e = parseInt(t.target.x2.baseVal.value)), (i = parseInt(t.target.y2.baseVal.value))),
                                            (f.style.top = (i || s) + a + "px"),
                                            (f.style.left = (e || o) + n + "px");
                                    }
                                }
                                var e = m.pointClass;
                                c instanceof y.Bar ? (e = "ct-bar") : c instanceof y.Pie && (e = c.options.donut ? "ct-slice-donut" : "ct-slice-pie");
                                // var l = c.container,
                                var l = document.getElementById('clear-error'),
                                    f = l.querySelector(".chartist-tooltip");
                                f || (((f = v.createElement("div")).className = m.class ? "chartist-tooltip " + m.class : "chartist-tooltip"), m.appendToBody ? v.body.appendChild(f) : l.appendChild(f));
                                ...
                                i(f),
                                    t("mouseover", e, function (t) {
                                        var e,
                                            ...
                                            n = t.target,
                                            a = "",
                                            r = (c instanceof y.Pie ? n : n.parentNode) ? n.parentNode.getAttribute("ct:meta") || n.parentNode.getAttribute("ct:series-name") : "",
                                            o = n.getAttribute("ct:meta") || r || "",
                                            s = !!o,
                                            l = n.getAttribute("ct:value");
                                        if ((m.transformTooltipTextFnc && "function" == typeof m.transformTooltipTextFnc && (l = m.transformTooltipTextFnc(l)), m.tooltipFnc && "function" == typeof m.tooltipFnc)) a = m.tooltipFnc(o, l);
                                        else {
                                            if (m.metaIsHTML) {
                                                var u = v.createElement("textarea");
                                                (u.innerHTML = o), (o = u.value);
                                            }
                                            if (((o = '<span class="chartist-tooltip-meta">' + o + "</span>"), s)) a += o + "<br>";
                                            else if (c instanceof y.Pie) {
                                                var d = (function (t, e) {
                                                    for (; (t = t.nextSibling) && !b(t, e); );
                                                    return t;
                                                })(n, "ct-label");
                                                d && (a += ((e = d).innerText || e.textContent) + "<br>");
                                            }
                                            l &&
                                                (m.currency && (l = null != m.currencyFormatCallback ? m.currencyFormatCallback(l, m) : m.currency + l.replace(/(\d)(?=(\d{3})+(?:\.\d+)?$)/g, "$1,")),
                                                (a += l = '<span class="chartist-tooltip-value">' + l + "</span>"));
                                        }
                                        a && ((f.innerHTML = a), h(t), b((i = f), "tooltip-show") || (i.className = i.className + " tooltip-show"), (g = f.offsetHeight), (p = f.offsetWidth));
                                    }),
    ...
    (function (t, e) {
        ...
        return (
            (function (t, e, o) {
                "use strict";
                var i = { axisTitle: "", axisClass: "ct-axis-title", offset: { x: 0, y: 0 }, textAnchor: "middle", flipText: !1 },
                    n = { xAxis: i, yAxis: i };
                (o.plugins = o.plugins || {}),
                        ...
                        return (
                            ...
                            function (t) {
                                t.on("created", function (t) {
                                    if (!r.axisX.axisTitle && !r.axisY.axisTitle) throw new Error("ctAxisTitle plugin - You must provide at least one axis title");
                                    if (!t.axisX && !t.axisY) throw new Error("ctAxisTitle plugin can only be used on charts that have at least one axis");
                                    var e, i, n;
                                    if (
                                        (r.axisX.axisTitle &&
                                            t.axisX &&
                                            ((e = t.axisX.axisLength / 2 + t.options.axisX.offset + t.options.chartPadding.left),
                                            (i = t.options.chartPadding.top),
                                            "end" === t.options.axisX.position && (i += t.axisY.axisLength),
                                            (n = new o.Svg("text")).addClass(r.axisX.axisClass),
                                            n.text(r.axisX.axisTitle),
                                            n.attr({ x: e + r.axisX.offset.x, y: i + r.axisX.offset.y, "text-anchor": r.axisX.textAnchor }),
                                            t.svg.append(n, !0)),
                                        r.axisY.axisTitle && t.axisY)
                                    ) {
                                        (e = 0), (i = t.axisY.axisLength / 2 + t.options.chartPadding.top), "end" === t.options.axisY.position && (e = t.axisX.axisLength);
                                        var a = "rotate(" + (r.axisY.flipTitle ? -90 : 90) + ", " + e + ", " + i + ")";
                                        (n = new o.Svg("text")).addClass(r.axisY.axisClass),
                                            n.text(r.axisY.axisTitle),
                                            n.attr({ x: e + r.axisY.offset.x, y: i + r.axisY.offset.y, transform: a, "text-anchor": r.axisY.textAnchor }),
                                            t.svg.append(n, !0);
                                    }
                                });
                            }
    ...
    (function (e, i) {
        ...
        "use strict";
        var e = { className: "", classNames: !1, removeAll: !1, legendNames: !1, clickable: !0, onClick: null, position: "top" };
        return (
            (r.plugins = r.plugins || {}),
            (r.plugins.legend = function (h) {
                ...
                if (h && h.position) {
                    if (!("top" === h.position || "bottom" === h.position || h.position instanceof HTMLElement)) throw Error("The position you entered is not a valid position");
                ...
                return (
                    ...
                    function (o) {
                        ...
                        var t = document.getElementById('clear-error').querySelector(".ct-legend");
                        if ((t && t.parentNode.removeChild(t), h.clickable)) {
                            var e = o.data.series.map(function (t, e) {
                                return "object" != typeof t && (t = { value: t }), (t.className = t.className || o.options.classNames.series + "-" + r.alphaNumerate(e)), t;
                            });
                            o.data.series = e;
                        }
                        var s = document.createElement("ul"),
                            i = o instanceof r.Pie;
                        (s.className = "ct-legend"), o instanceof r.Pie && s.classList.add("ct-legend-inside"), "string" == typeof h.className && 0 < h.className.length && s.classList.add(h.className);
                        var l = [],
                        ...
                        n = h.legendNames || n;
                        var a = Array.isArray(h.classNames) && h.classNames.length === n.length;
                        n.forEach(function (t, e) {
                            var i = document.createElement("li");
                            (i.className = "ct-series-" + e), a && (i.className += " " + h.classNames[e]), i.setAttribute("data-legend", e), (i.textContent = t.name || t), s.appendChild(i);
                        }),
                            o.on("created", function (t) {
                                if (h.position instanceof HTMLElement) h.position.insertBefore(s, null);
                                else
                                    switch (h.position) {
                                        case "top":
                                            // o.container.insertBefore(s, o.container.childNodes[0]);
                                            document.getElementById('clear-error').insertBefore(s, document.getElementById('clear-error').childNodes[0]);
                                            break;
                                        case "bottom":
                                            // o.container.insertBefore(s, null);
                                            document.getElementById('clear-error').insertBefore(s, null);
                                    }
                            }),
                            h.clickable &&
                                s.addEventListener("click", function (t) {
                                    ...
                                    if (e.parentNode === s && e.hasAttribute("data-legend")) {
                                        ...
                                        else if (h.removeAll) l.push(i), e.classList.add("inactive");
                                        else if (1 < o.data.series.length) l.push(i), e.classList.add("inactive");
                                        else
                                            (l = []),
                                                Array.prototype.slice.call(s.childNodes).forEach(function (t) {
        ...
        })(
            {
                ...
                2: [
                    function (t, e, i) {
                        ...
                        (o.prototype = {
                            ...
                            (o.prototype.maxes = { rgb: [255, 255, 255], hsl: [360, 100, 100], hsv: [360, 100, 100], hwb: [360, 100, 100], cmyk: [100, 100, 100, 100] }),
                ...
                3: [
                    function (t, e, i) {
                        ...
                        function c(t) {
                            ...
                            for (var u = 0; u < 3; u++) (n = o + (1 / 3) * -(u - 1)) < 0 && n++, 1 < n && n--, (r = 6 * n < 1 ? e + 6 * (i - e) * n : 2 * n < 1 ? i : 3 * n < 2 ? e + (i - e) * (2 / 3 - n) * 6 : e), (a[u] = 255 * r);
                            return a;
                        }
                        function h(t) {
                            var e = t[0] / 60,
                        ...
                        function m(t) {
                            ...
                            return (
                                ...
                                (e = 0.0031308 < (e = 3.2406 * a + -1.5372 * r + -0.4986 * o) ? 1.055 * Math.pow(e, 1 / 2.4) - 0.055 : (e *= 12.92)),
                        ...
                        function y(t) {
                            var e,
                                ...
                                s = t[2];
                            return (
                                (a = r <= 8 ? ((i = (100 * r) / 903.3) / 100) * 7.787 + 16 / 116 : ((i = 100 * Math.pow((r + 16) / 116, 3)), Math.pow(i / 100, 1 / 3))),
                                [
                ...
                6: [
                    function (Li, Ri, t) {
                        ...
                        (e = this),
                            (i = function () {
                                ...
                                function m(t) {
                                    if (null == t._isValid) {
                                        ...
                                        (t._isValid =
                                            !isNaN(t._d.getTime()) && e.overflow < 0 && !e.empty && !e.invalidMonth && !e.invalidWeekday && !e.nullInput && !e.invalidFormat && !e.userInvalidated && (!e.meridiem || (e.meridiem && i))),
                                ...
                                var e = !1;
                                function b(t) {
                                    y(this, t), (this._d = new Date(null != t._d ? t._d.getTime() : NaN)), !1 === e && ((e = !0), h.updateOffset(this), (e = !1));
                                }
                                function x(t) {
                                ...
                                function i(t, e) {
                                    ...
                                    return c(function () {
                                        return (
                                            null != h.deprecationHandler && h.deprecationHandler(null, t),
                                ...
                                var _,
                                    M = {};
                                function C(t, e) {
                                    null != h.deprecationHandler && h.deprecationHandler(t, e), M[t] || (a(e), (M[t] = !0));
                                }
                                function D(t) {
                                ...
                                function A(t, e) {
                                    var i,
                                        n = c({}, t);
                                    for (i in e) f(e, i) && (l(t[i]) && l(e[i]) ? ((n[i] = {}), c(n[i], t[i]), c(n[i], e[i])) : null != e[i] ? (n[i] = e[i]) : delete n[i]);
                                    for (i in t) f(t, i) && !f(e, i) && l(t[i]) && (n[i] = c({}, n[i]));
                                    return n;
                                }
                                function T(t) {
                                    null != t && this.set(t);
                                ...
                                function V(e, i) {
                                    return function (t) {
                                        return null != t ? (z(this, e, t), h.updateOffset(this, i), this) : W(this, e);
                                    };
                                }
                                function W(t, e) {
                                          ...
                                          (Y[e] =
                                              ...
                                              (function (n) {
                                                  ...
                                                  return function (t) {
                                                      var e,
                                                          i = "";
                                                      for (e = 0; e < a; e++) i += r[e] instanceof Function ? r[e].call(t, n) : r[e];
                                                      return i;
                                                  };
                                              })(e)),
                                          Y[e](t))
                                ...
                                function G(t, e) {
                                    ...
                                    for (N.lastIndex = 0; 0 <= i && N.test(t); ) (t = t.replace(N, n)), (N.lastIndex = 0), (i -= 1);
                                    return t;
                                }
                                var q = /\d/,
                                    X = /\d\d/,
                                ...
                                function It(t) {
                                    return null != t ? (Pt(this, t), h.updateOffset(this, !0), this) : W(this, "Month");
                                }
                                var Ot = lt;
                                var Ft = lt;
                                function Lt() {
                                ...
                                function Bt(t, e, i, n, a) {
                                    ...
                                    return (o = s <= 0 ? Rt((r = t - 1)) + s : s > Rt(t) ? ((r = t + 1), s - Rt(t)) : ((r = t), s)), { year: r, dayOfYear: o };
                                }
                                function Nt(t, e, i) {
                                    var n,
                                        a,
                                    ...
                                    return o < 1 ? (n = o + Yt((a = t.year() - 1), e, i)) : o > Yt(t.year(), e, i) ? ((n = o - Yt(t.year(), e, i)), (a = t.year() + 1)) : ((a = t.year()), (n = o)), { week: n, year: a };
                                }
                                function Yt(t, e, i) {
                                    var n = Et(t, e, i),
                                        a = Et(t + 1, e, i);
                                ...
                                function Zt() {
                                    ...
                                    var e,
                                        ...
                                        u = [];
                                    for (e = 0; e < 7; e++)
                                        (i = g([2e3, 1]).day(e)), (n = this.weekdaysMin(i, "")), (a = this.weekdaysShort(i, "")), (r = this.weekdays(i, "")), o.push(n), s.push(a), l.push(r), u.push(n), u.push(a), u.push(r);
                                ...
                                U("H", ["HH", 2], 0, "hour"),
                                    ...
                                    U("hmmss", 0, 0, function () {
                                        return "" + Jt.apply(this) + E(this.minutes(), 2) + E(this.seconds(), 2);
                                    }),
                                    U("Hmm", 0, 0, function () {
                                    ...
                                    gt("hmm", function (t, e, i) {
                                        var n = t.length - 2;
                                        (e[xt] = k(t.substr(0, n))), (e[wt] = k(t.substr(n))), (p(i).bigHour = !0);
                                    }),
                                    gt("hmmss", function (t, e, i) {
                                        var n = t.length - 4,
                                            a = t.length - 2;
                                        (e[xt] = k(t.substr(0, n))), (e[wt] = k(t.substr(n, 2))), (e[kt] = k(t.substr(a))), (p(i).bigHour = !0);
                                    }),
                                    gt("Hmm", function (t, e, i) {
                                        var n = t.length - 2;
                                    ...
                                    gt("Hmmss", function (t, e, i) {
                                        var n = t.length - 4,
                                            a = t.length - 2;
                                        (e[xt] = k(t.substr(0, n))), (e[wt] = k(t.substr(n, 2))), (e[kt] = k(t.substr(a)));
                                    });
                                var Kt,
                                    te = V("Hours", !0),
                                    ee = {
                                        ...
                                        null != ie[t]
                                            ...
                                            : null != e.parentLocale &&
                                              (null != ie[e.parentLocale]
                                                  ...
                                                  : C("parentLocaleUndefined", "specified parentLocale is not defined yet. See http://momentjs.com/guides/#/warnings/parent-locale/")),
                                        (ie[t] = new T(A(i, e))),
                                        re(t),
                                        ie[t]
                                    );
                                ...
                                function se(t) {
                                    ...
                                    return (function (t) {
                                        for (var e, i, n, a, r = 0; r < t.length; ) {
                                            for (e = (a = ne(t[r]).split("-")).length, i = (i = ne(t[r + 1])) ? i.split("-") : null; 0 < e; ) {
                                        ...
                                        i &&
                                            ...
                                            ((e =
                                                i[yt] < 0 || 11 < i[yt]
                                                    ...
                                                    ? bt
                                                    : i[xt] < 0 || 24 < i[xt] || (24 === i[xt] && (0 !== i[wt] || 0 !== i[kt] || 0 !== i[St]))
                                                    ? xt
                                                    : i[wt] < 0 || 59 < i[wt]
                                                    ? wt
                                                    : i[kt] < 0 || 59 < i[kt]
                                ...
                                function ve(t) {
                                    ...
                                    if (!t._d) {
                                        ...
                                        for (
                                            o = t,
                                                s = new Date(h.now()),
                                                n = o._useUTC ? [s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate()] : [s.getFullYear(), s.getMonth(), s.getDate()],
                                                t._w &&
                                                    null == t._a[bt] &&
                                                    null == t._a[yt] &&
                                                    (function (t) {
                                                        ...
                                                        null != (e = t._w).GG || null != e.W || null != e.E
                                                            ? ((r = 1), (o = 4), (i = me(e.GG, t._a[vt], Nt(we(), 1, 4).year)), (n = me(e.W, 1)), ((a = me(e.E, 1)) < 1 || 7 < a) && (l = !0))
                                                            : ((r = t._locale._week.dow),
                                                              (o = t._locale._week.doy),
                                                              (i = me(e.gg, t._a[vt], Nt(we(), r, o).year)),
                                                              (n = me(e.w, 1)),
                                                              null != e.d ? ((a = e.d) < 0 || 6 < a) && (l = !0) : null != e.e ? ((a = e.e + r), (e.e < 0 || 6 < e.e) && (l = !0)) : (a = r));
                                                        n < 1 || n > Yt(i, r, o) ? (p(t)._overflowWeeks = !0) : null != l ? (p(t)._overflowWeekday = !0) : ((s = Bt(i, n, a, r, o)), (t._a[vt] = s.year), (t._dayOfYear = s.dayOfYear));
                                                    })(t),
                                                t._dayOfYear && ((a = me(t._a[vt], n[vt])), t._dayOfYear > Rt(a) && (p(t)._overflowDayOfYear = !0), (i = zt(a, 0, t._dayOfYear)), (t._a[yt] = i.getUTCMonth()), (t._a[bt] = i.getUTCDate())),
                                                e = 0;
                                            e < 3 && null == t._a[e];
                                            ++e
                                        )
                                        ...
                                        24 === t._a[xt] && 0 === t._a[wt] && 0 === t._a[kt] && 0 === t._a[St] && ((t._nextDay = !0), (t._a[xt] = 0)),
                                            (t._d = (t._useUTC
                                                ? zt
                                ...
                                function ye(t) {
                                    if (t._f !== h.ISO_8601) {
                                        ...
                                        var e,
                                            ...
                                            d = u.length,
                                            c = 0;
                                        for (n = G(t._f, t._locale).match(B) || [], e = 0; e < n.length; e++)
                                            (a = n[e]),
                                                (i = (u.match(ct(a, t)) || [])[0]) && (0 < (r = u.substr(0, u.indexOf(i))).length && p(t).unusedInput.push(r), (u = u.slice(u.indexOf(i) + i.length)), (c += i.length)),
                                                H[a] ? (i ? (p(t).empty = !1) : p(t).unusedTokens.push(a), (o = a), (l = t), null != (s = i) && f(ft, o) && ft[o](s, l._a, l, o)) : t._strict && !i && p(t).unusedTokens.push(a);
                                        (p(t).charsLeftOver = d - c),
                                            0 < u.length && p(t).unusedInput.push(u),
                                            t._a[xt] <= 12 && !0 === p(t).bigHour && 0 < t._a[xt] && (p(t).bigHour = void 0),
                                            ...
                                            : ("string" == typeof r && (t._i = r = t._locale.preparse(r)),
                                              x(r)
                                                  ...
                                                  : (s(o)
                                                        ? (function (t) {
                                                              ...
                                                              for (a = 0; a < t._f.length; a++)
                                                                  (r = 0),
                                                                      ...
                                                                      (e._f = t._f[a]),
                                                                      ye(e),
                                                                      m(e) && ((r += p(e).charsLeftOver), (r += 10 * p(e).unusedTokens.length), (p(e).score = r), (null == n || r < n) && ((n = r), (i = e)));
                                                              c(t, i || e);
                                                          })(t)
                                                        : u(r)
                                                        ? (t._d = r)
                                                        ...
                                                        : "string" == typeof i
                                                        ? ((n = e), null === (a = ge.exec(n._i)) ? (pe(n), !1 === n._isValid && (delete n._isValid, h.createFromInputFallback(n))) : (n._d = new Date(+a[1])))
                                                        : s(i)
                                ...
                                function xe(t, e, i, n, a) {
                                    ...
                                    return (
                                        ...
                                        (o._f = e),
                                        (o._strict = n),
                                        (r = new b(le(be(o))))._nextDay && (r.add(1, "d"), (r._nextDay = void 0)),
                                        r
                                    );
                                }
                                function we(t, e, i, n) {
                                ...
                                function _e(t, e) {
                                    var i, n;
                                    if ((1 === e.length && s(e[0]) && (e = e[0]), !e.length)) return we();
                                ...
                                function Me(t) {
                                    var e = F(t),
                                        ...
                                        u = e.second || 0,
                                        d = e.millisecond || 0;
                                    (this._milliseconds = +d + 1e3 * u + 6e4 * l + 1e3 * s * 60 * 60), (this._days = +o + 7 * r), (this._months = +a + 3 * n + 12 * i), (this._data = {}), (this._locale = se()), this._bubble();
                                }
                                function Ce(t) {
                                ...
                                function De(t, i) {
                                    U(t, 0, 0, function () {
                                        var t = this.utcOffset(),
                                            e = "+";
                                        return t < 0 && ((t = -t), (e = "-")), e + E(~~(t / 60), 2) + i + E(~~t % 60, 2);
                                    });
                                }
                                De("Z", ":"),
                                    De("ZZ", ""),
                                ...
                                function Pe(t, e) {
                                    var i, n;
                                    return e._isUTC ? ((i = e.clone()), (n = (x(t) || u(t) ? t.valueOf() : we(t).valueOf()) - i.valueOf()), i._d.setTime(i._d.valueOf() + n), h.updateOffset(i, !1), i) : we(t).local();
                                }
                                function Ie(t) {
                                ...
                                function Re(t, e) {
                                    ...
                                    return (
                                        Ce(t)
                                            ...
                                            : (o = Fe.exec(t))
                                            ? ((i = "-" === o[1] ? -1 : 1), (r = { y: 0, d: k(o[bt]) * i, h: k(o[xt]) * i, m: k(o[wt]) * i, s: k(o[kt]) * i, ms: k(o[St]) * i }))
                                            : (o = Le.exec(t))
                                            ? ((i = "-" === o[1] ? -1 : 1), (r = { y: Ve(o[2], i), M: Ve(o[3], i), w: Ve(o[4], i), d: Ve(o[5], i), h: Ve(o[6], i), m: Ve(o[7], i), s: Ve(o[8], i) }))
                                            : null == r
                                            ? (r = {})
                                            : "object" == typeof r &&
                                              ("from" in r || "to" in r) &&
                                              ((a = (function (t, e) {
                                                  ...
                                                  (e = Pe(e, t)), t.isBefore(e) ? (i = We(t, e)) : (((i = We(e, t)).milliseconds = -i.milliseconds), (i.months = -i.months));
                                                  return i;
                                              })(we(r.from), we(r.to))),
                                              ((r = {}).ms = a.milliseconds),
                                              (r.M = a.months)),
                                ...
                                function Be(t, e, i, n) {
                                    var a = e._milliseconds,
                                        r = ze(e._days),
                                        o = ze(e._months);
                                    t.isValid() && ((n = null == n || n), a && t._d.setTime(t._d.valueOf() + a * i), r && z(t, "Date", W(t, "Date") + r * i), o && Pt(t, W(t, "Month") + o * i), n && h.updateOffset(t, r || o));
                                }
                                Re.fn = Me.prototype;
                                var Ne = Ee(1, "add"),
                                    Ye = Ee(-1, "subtract");
                                ...
                                var Ue = i("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function (t) {
                                ...
                                U("DDD", ["DDDD", 3], "DDDo", "dayOfYear"),
                                    ...
                                    gt(["m", "mm"], wt);
                                var Ze = V("Minutes", !1);
                                U("s", ["ss", 2], 0, "second"), I("second", "s"), R("second", 15), dt("s", $), dt("ss", $, X), gt(["s", "ss"], kt);
                                var Je,
                                    Qe = V("Seconds", !1);
                                for (
                                    U("S", 0, 0, function () {
                                ...
                                (ti.add = Ne),
                                    (ti.calendar = function (t, e) {
                                        ...
                                        return this.format(r || this.localeData().calendar(a, this, we(i)));
                                    }),
                                    (ti.clone = function () {
                                        return new b(this);
                                    }),
                                    (ti.diff = function (t, e, i) {
                                        ...
                                        return this.isValid() && (n = Pe(t, this)).isValid()
                                            ? ((a = 6e4 * (n.utcOffset() - this.utcOffset())),
                                              "year" === (e = O(e)) || "month" === e || "quarter" === e
                                                  ? ((s = this),
                                                    (l = n),
                                                    (c = 12 * (l.year() - s.year()) + (l.month() - s.month())),
                                                    (h = s.clone().add(c, "months")),
                                                    (d = l - h < 0 ? ((u = s.clone().add(c - 1, "months")), (l - h) / (h - u)) : ((u = s.clone().add(c + 1, "months")), (l - h) / (u - h))),
                                                    (o = -(c + d) || 0),
                                                    "quarter" === e ? (o /= 3) : "year" === e && (o /= 12))
                                                  : ((r = this - n), (o = "second" === e ? r / 1e3 : "minute" === e ? r / 6e4 : "hour" === e ? r / 36e5 : "day" === e ? (r - a) / 864e5 : "week" === e ? (r - a) / 6048e5 : r)),
                                              i ? o : w(o))
                                            : NaN;
                                        var s, l, u, d, c, h;
                                    }),
                                    ...
                                    (ti.from = function (t, e) {
                                        return this.isValid() && ((x(t) && t.isValid()) || we(t).isValid()) ? Re({ to: this, from: t }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate();
                                    }),
                                    (ti.fromNow = function (t) {
                                        return this.from(we(), t);
                                    }),
                                    (ti.to = function (t, e) {
                                        return this.isValid() && ((x(t) && t.isValid()) || we(t).isValid()) ? Re({ from: this, to: t }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate();
                                    }),
                                    (ti.toNow = function (t) {
                                        return this.to(we(), t);
                                    }),
                                    ...
                                    (ti.isAfter = function (t, e) {
                                        var i = x(t) ? t : we(t);
                                        return !(!this.isValid() || !i.isValid()) && ("millisecond" === (e = O(r(e) ? "millisecond" : e)) ? this.valueOf() > i.valueOf() : i.valueOf() < this.clone().startOf(e).valueOf());
                                    }),
                                    (ti.isBefore = function (t, e) {
                                        var i = x(t) ? t : we(t);
                                        return !(!this.isValid() || !i.isValid()) && ("millisecond" === (e = O(r(e) ? "millisecond" : e)) ? this.valueOf() < i.valueOf() : this.clone().endOf(e).valueOf() < i.valueOf());
                                    }),
                                    ...
                                    (ti.isSame = function (t, e) {
                                        ...
                                        return (
                                            ...
                                            ("millisecond" === (e = O(e || "millisecond")) ? this.valueOf() === n.valueOf() : ((i = n.valueOf()), this.clone().startOf(e).valueOf() <= i && i <= this.clone().endOf(e).valueOf()))
                                        );
                                    }),
                                    ...
                                    (ti.quarter = ti.quarters = function (t) {
                                    ...
                                    (ti.week = ti.weeks = function (t) {
                                        var e = this.localeData().week(this);
                                        return null == t ? e : this.add(7 * (t - e), "d");
                                    }),
                                    (ti.isoWeek = ti.isoWeeks = function (t) {
                                    ...
                                    (ti.utcOffset = function (t, e) {
                                        ...
                                        return this.isValid()
                                            ? null != t
                                                ? ("string" == typeof t ? (t = Te(st, t)) : Math.abs(t) < 16 && (t *= 60),
                                                  !this._isUTC && e && (i = Ie(this)),
                                                  (this._offset = t),
                                                  (this._isUTC = !0),
                                                  null != i && this.add(i, "m"),
                                                  n !== t &&
                                                      (!e || this._changeInProgress ? Be(this, Re(t - n, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), h.updateOffset(this, !0), (this._changeInProgress = null))),
                                                  this)
                                                : this._isUTC
                                                ? n
                                                : Ie(this)
                                    ...
                                    (ti.parseZone = function () {
                                        return this._tzm ? this.utcOffset(this._tzm) : "string" == typeof this._i && this.utcOffset(Te(ot, this._i)), this;
                                    }),
                                    ...
                                    (ti.dates = i("dates accessor is deprecated. Use date instead.", Xe)),
                                    (ti.months = i("months accessor is deprecated. Use month instead", It)),
                                    (ti.years = i("years accessor is deprecated. Use year instead", Wt)),
                                    (ti.zone = i("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function (t, e) {
                                        return null != t ? ("string" != typeof t && (t = -t), this.utcOffset(t, e), this) : -this.utcOffset();
                                    })),
                                    (ti.isDSTShifted = i("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function () {
                                ...
                                function ri(t, e, i) {
                                    if (("number" == typeof t && ((e = t), (t = void 0)), (t = t || ""), null != e)) return ai(t, e, i, "month");
                                    var n,
                                        a = [];
                                ...
                                function oi(t, e, i, n) {
                                    e = ("boolean" == typeof t ? "number" == typeof e && ((i = e), (e = void 0)) : ((e = t), (t = !1), "number" == typeof (i = e) && ((i = e), (e = void 0))), e || "");
                                    var a,
                                        r = se(),
                                        o = t ? r._week.dow : 0;
                                ...
                                (ni.calendar = function (t, e, i) {
                                    ...
                                    (ni.months = function (t, e) {
                                        return s(this._months) ? this._months[t.month()] : this._months[(this._months.isFormat || Dt).test(e) ? "format" : "standalone"][t.month()];
                                    }),
                                    (ni.monthsShort = function (t, e) {
                                        return s(this._monthsShort) ? this._monthsShort[t.month()] : this._monthsShort[Dt.test(e) ? "format" : "standalone"][t.month()];
                                    }),
                                            ...
                                            return function (t, e, i) {
                                                ...
                                                if (!this._monthsParse)
                                                    for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], n = 0; n < 12; ++n)
                                                        (r = g([2e3, n])), (this._shortMonthsParse[n] = this.monthsShort(r, "").toLocaleLowerCase()), (this._longMonthsParse[n] = this.months(r, "").toLocaleLowerCase());
                                                return i
                                                    ? "MMM" === e
                                    ...
                                    (ni.monthsRegex = function (t) {
                                        return this._monthsParseExact
                                            ? (f(this, "_monthsRegex") || Lt.call(this), t ? this._monthsStrictRegex : this._monthsRegex)
                                            : (f(this, "_monthsRegex") || (this._monthsRegex = Ft), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex);
                                    }),
                                    (ni.monthsShortRegex = function (t) {
                                        return this._monthsParseExact
                                            ? (f(this, "_monthsRegex") || Lt.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex)
                                            : (f(this, "_monthsShortRegex") || (this._monthsShortRegex = Ot), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex);
                                    }),
                                    (ni.week = function (t) {
                                    ...
                                    (ni.weekdays = function (t, e) {
                                        return s(this._weekdays) ? this._weekdays[t.day()] : this._weekdays[this._weekdays.isFormat.test(e) ? "format" : "standalone"][t.day()];
                                    }),
                                    ...
                                    (ni.weekdaysRegex = function (t) {
                                        return this._weekdaysParseExact
                                            ...
                                            : (f(this, "_weekdaysRegex") || (this._weekdaysRegex = Gt), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex);
                                    }),
                                    (ni.weekdaysShortRegex = function (t) {
                                        return this._weekdaysParseExact
                                            ...
                                            : (f(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = qt), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
                                    }),
                                    (ni.weekdaysMinRegex = function (t) {
                                        return this._weekdaysParseExact
                                            ? (f(this, "_weekdaysRegex") || Zt.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
                                            : (f(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Xt), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
                                    }),
                                    (ni.isPM = function (t) {
                                    ...
                                    (h.lang = i("moment.lang is deprecated. Use moment.locale instead.", re)),
                                    (h.langData = i("moment.langData is deprecated. Use moment.localeData instead.", se));
                                var si = Math.abs;
                                function li(t, e, i, n) {
                                    var a = Re(e, i);
                                ...
                                return (
                                    ...
                                    (Fi.as = function (t) {
                                        ...
                                        if ("month" === (t = O(t)) || "year" === t) return (e = this._days + n / 864e5), (i = this._months + di(e)), "month" === t ? i : i / 12;
                                        switch (((e = this._days + Math.round(ci(this._months))), t)) {
                                            case "week":
                                                return e / 7 + n / 6048e5;
                                            case "day":
                                                return e + n / 864e5;
                                    ...
                                    (Fi._bubble = function () {
                                        var t,
                                            ...
                                            l = this._data;
                                        return (
                                            (0 <= r && 0 <= o && 0 <= s) || (r <= 0 && o <= 0 && s <= 0) || ((r += 864e5 * ui(ci(s) + o)), (s = o = 0)),
                                    ...
                                    (Fi.locale = He),
                                    (Fi.localeData = je),
                                    (Fi.toIsoString = i("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Oi)),
                                    (Fi.lang = Ue),
                                    U("X", 0, 0, "unix"),
                                    U("x", 0, 0, "valueOf"),
                                    dt("x", rt),
                                    ...
                                    (h.updateLocale = function (t, e) {
                                        if (null != e) {
                                            var i,
                                                n = ee;
                                            null != ie[t] && (n = ie[t]._config), ((i = new T((e = A(n, e)))).parentLocale = ie[t]), (ie[t] = i), re(t);
                            ...
                            "object" == typeof t && void 0 !== Ri ? (Ri.exports = i()) : (e.moment = i());
                    },
                    {},
                ],
                7: [
                    ...
                    function (t, e, i) {
                        ...
                        e.exports = function (i) {
                            i.Radar = function (t, e) {
                                return (e.options = i.helpers.configMerge({ aspectRatio: 1 }, e.options)), (e.type = "radar"), new i(t, e);
                            };
                        };
                    },
                    {},
                ...
                15: [
                    function (t, e, i) {
                        ...
                        e.exports = function (i) {
                            var c = i.helpers;
                            (i.defaults.bar = { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", categoryPercentage: 0.8, barPercentage: 0.9, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } }),
                                (i.controllers.bar = i.DatasetController.extend({
                                    ...
                                    updateElement: function (t, e, i) {
                                        ...
                                        c.extend(t, {
                                            ...
                                            _model: {
                                                ...
                                                backgroundColor: u.backgroundColor ? u.backgroundColor : c.getValueAtIndexOrDefault(d.backgroundColor, e, l.backgroundColor),
                                                borderSkipped: u.borderSkipped ? u.borderSkipped : l.borderSkipped,
                                                borderColor: u.borderColor ? u.borderColor : c.getValueAtIndexOrDefault(d.borderColor, e, l.borderColor),
                                                borderWidth: u.borderWidth ? u.borderWidth : c.getValueAtIndexOrDefault(d.borderWidth, e, l.borderWidth),
                                            },
                                        }),
                                            t.pivot();
                                    },
                                    calculateBarBase: function (t, e) {
                                        ...
                                        if (n.options.stacked) {
                                            for (var r = this.chart, o = r.data.datasets, s = Number(o[t].data[e]), l = 0; l < t; l++) {
                                                var u = o[l],
                                                    d = r.getDatasetMeta(l);
                                                if (d.bar && d.yAxisID === n.id && r.isDatasetVisible(l)) {
                                    ...
                                    getRuler: function (t) {
                                        var e,
                                            ...
                                            r = i.getBarCount(),
                                            o = (e = "category" === a.options.type ? a.getPixelForTick(t + 1) - a.getPixelForTick(t) : a.width / a.ticks.length) * a.options.categoryPercentage,
                                            s = (e - e * a.options.categoryPercentage) / 2,
                                            l = o / r;
                                        a.ticks.length !== i.chart.data.labels.length && (l *= a.ticks.length / i.chart.data.labels.length);
                                        return { datasetCount: r, tickWidth: e, categoryWidth: o, categorySpacing: s, fullBarWidth: l, barWidth: l * a.options.barPercentage, barSpacing: l - l * a.options.barPercentage };
                                    },
                                    ...
                                    calculateBarX: function (t, e) {
                                        ...
                                        return (
                                            ...
                                            a.options.stacked ? s + o.categoryWidth / 2 + o.categorySpacing : s + o.barWidth / 2 + o.categorySpacing + o.barWidth * r + o.barSpacing / 2 + o.barSpacing * r
                                        );
                                    },
                                    calculateBarY: function (t, e) {
                                        ...
                                        if (a.options.stacked) {
                                            for (var o = 0, s = 0, l = 0; l < e; l++) {
                                                ...
                                                if (d.bar && d.yAxisID === a.id && i.chart.isDatasetVisible(l)) {
                                                    var c = Number(u.data[t]);
                                                    c < 0 ? (s += c || 0) : (o += c || 0);
                                                }
                                            }
                                            return r < 0 ? a.getPixelForValue(s + r) : a.getPixelForValue(o + r);
                                        }
                                    ...
                                    setHoverStyle: function (t) {
                                        var e = this.chart.data.datasets[t._datasetIndex],
                                            ...
                                            n = t.custom || {},
                                            a = t._model;
                                        (a.backgroundColor = n.hoverBackgroundColor ? n.hoverBackgroundColor : c.getValueAtIndexOrDefault(e.hoverBackgroundColor, i, c.getHoverColor(a.backgroundColor))),
                                            (a.borderColor = n.hoverBorderColor ? n.hoverBorderColor : c.getValueAtIndexOrDefault(e.hoverBorderColor, i, c.getHoverColor(a.borderColor))),
                                            (a.borderWidth = n.hoverBorderWidth ? n.hoverBorderWidth : c.getValueAtIndexOrDefault(e.hoverBorderWidth, i, a.borderWidth));
                                    },
                                    removeHoverStyle: function (t) {
                                        ...
                                        (a.backgroundColor = n.backgroundColor ? n.backgroundColor : c.getValueAtIndexOrDefault(e.backgroundColor, i, r.backgroundColor)),
                                            (a.borderColor = n.borderColor ? n.borderColor : c.getValueAtIndexOrDefault(e.borderColor, i, r.borderColor)),
                                            (a.borderWidth = n.borderWidth ? n.borderWidth : c.getValueAtIndexOrDefault(e.borderWidth, i, r.borderWidth));
                                    },
                                })),
                                ...
                                (i.controllers.horizontalBar = i.controllers.bar.extend({
                                    updateElement: function (t, e, i) {
                                        ...
                                        c.extend(t, {
                                            ...
                                            _model: {
                                                ...
                                                backgroundColor: l.backgroundColor ? l.backgroundColor : c.getValueAtIndexOrDefault(u.backgroundColor, e, d.backgroundColor),
                                                borderSkipped: l.borderSkipped ? l.borderSkipped : d.borderSkipped,
                                                borderColor: l.borderColor ? l.borderColor : c.getValueAtIndexOrDefault(u.borderColor, e, d.borderColor),
                                                borderWidth: l.borderWidth ? l.borderWidth : c.getValueAtIndexOrDefault(u.borderWidth, e, d.borderWidth),
                                            },
                                            draw: function () {
                                                var t = this._chart.ctx,
                                                    ...
                                                    r = e.base - (e.base - e.x),
                                                    o = e.borderWidth / 2;
                                                e.borderWidth && ((n += o), (a -= o), (r += o)), t.beginPath(), (t.fillStyle = e.backgroundColor), (t.strokeStyle = e.borderColor), (t.lineWidth = e.borderWidth);
                                                var s = [
                                                        [e.base, a],
                                                        [e.base, n],
                                                        [r, n],
                                                    ...
                                                    l = ["bottom", "left", "top", "right"].indexOf(e.borderSkipped, 0);
                                                function u(t) {
                                                    return s[(l + t) % 4];
                                                }
                                            ...
                                            inRange: function (t, e) {
                                                var i = this._view,
                                                    n = !1;
                                                return (
                                                    i && (n = i.x < i.base ? e >= i.y - i.height / 2 && e <= i.y + i.height / 2 && t >= i.x && t <= i.base : e >= i.y - i.height / 2 && e <= i.y + i.height / 2 && t >= i.base && t <= i.x), n
                                                );
                                            },
                                        }),
                                            t.pivot();
                                    ...
                                    calculateBarBase: function (t, e) {
                                        ...
                                        if (n.options.stacked) {
                                            for (var r = this.chart, o = r.data.datasets, s = Number(o[t].data[e]), l = 0; l < t; l++) {
                                                var u = o[l],
                                                    d = r.getDatasetMeta(l);
                                                if (d.bar && d.xAxisID === n.id && r.isDatasetVisible(l)) {
                                                    var c = Number(u.data[e]);
                                                    a += s < 0 ? Math.min(c, 0) : Math.max(c, 0);
                                                }
                                            }
                                    ...
                                    getRuler: function (t) {
                                        var e,
                                            ...
                                            l = o / r;
                                        a.ticks.length !== i.chart.data.labels.length && (l *= a.ticks.length / i.chart.data.labels.length);
                                        return { datasetCount: r, tickHeight: e, categoryHeight: o, categorySpacing: s, fullBarHeight: l, barHeight: l * a.options.barPercentage, barSpacing: l - l * a.options.barPercentage };
                                    },
                                    ...
                                    calculateBarX: function (t, e) {
                                        ...
                                        if (a.options.stacked) {
                                            for (var o = 0, s = 0, l = 0; l < e; l++) {
                                                var u = i.chart.data.datasets[l],
                                                    d = i.chart.getDatasetMeta(l);
                                                if (d.bar && d.xAxisID === a.id && i.chart.isDatasetVisible(l)) {
                                                    var c = Number(u.data[t]);
                                                    c < 0 ? (s += c || 0) : (o += c || 0);
                                                }
                                            }
                                    ...
                                    calculateBarY: function (t, e) {
                                        ...
                                        return (
                                            ...
                                            a.options.stacked ? s + o.categoryHeight / 2 + o.categorySpacing : s + o.barHeight / 2 + o.categorySpacing + o.barHeight * r + o.barSpacing / 2 + o.barSpacing * r
                                        );
                                    },
                                }));
                        };
                                ...
                                (f.controllers.bubble = f.DatasetController.extend({
                                    ...
                                    updateElement: function (t, e, i) {
                                        ...
                                        g.extend(t, {
                                            ...
                                            _index: e,
                                            _model: {
                                                x: i ? r.getPixelForDecimal(0.5) : r.getPixelForValue("object" == typeof u ? u : NaN, e, c, n.chart.isCombo),
                                                y: i ? o.getBasePixel() : o.getPixelForValue(u, e, c),
                                                radius: i ? 0 : s.radius ? s.radius : n.getRadius(u),
                                                hitRadius: s.hitRadius ? s.hitRadius : g.getValueAtIndexOrDefault(l.hitRadius, e, d.hitRadius),
                                            },
                                        }),
                                            f.DatasetController.prototype.removeHoverStyle.call(n, t, d);
                                        var h = t._model;
                                    ...
                                    setHoverStyle: function (t) {
                                        ...
                                        var e = this.chart.data.datasets[t._datasetIndex],
                                            i = t._index,
                                            n = t.custom || {};
                                        t._model.radius = n.hoverRadius ? n.hoverRadius : g.getValueAtIndexOrDefault(e.hoverRadius, i, this.chart.options.elements.point.hoverRadius) + this.getRadius(e.data[i]);
                                    },
                                    removeHoverStyle: function (t) {
                                        ...
                                        generateLabels: function (l) {
                                            ...
                                            return u.labels.length && u.datasets.length
                                                ? u.labels.map(function (t, e) {
                                                      ...
                                                      return {
                                                          text: t,
                                                          fillStyle: r.backgroundColor ? r.backgroundColor : o(n.backgroundColor, e, s.backgroundColor),
                                                          strokeStyle: r.borderColor ? r.borderColor : o(n.borderColor, e, s.borderColor),
                                                          lineWidth: r.borderWidth ? r.borderWidth : o(n.borderWidth, e, s.borderWidth),
                                ...
                                (e.controllers.doughnut = e.controllers.pie = e.DatasetController.extend({
                                    ...
                                    update: function (i) {
                                        ...
                                        if (h < 2 * Math.PI) {
                                            var f = a.rotation % (2 * Math.PI),
                                                ...
                                                v = Math.cos(g),
                                                y = Math.sin(g),
                                                b = (f <= 0 && 0 <= g) || (f <= 2 * Math.PI && 2 * Math.PI <= g),
                                                x = (f <= 0.5 * Math.PI && 0.5 * Math.PI <= g) || (f <= 2.5 * Math.PI && 2.5 * Math.PI <= g),
                                                w = (f <= -Math.PI && -Math.PI <= g) || (f <= Math.PI && Math.PI <= g),
                                                k = (f <= 0.5 * -Math.PI && 0.5 * -Math.PI <= g) || (f <= 1.5 * Math.PI && 1.5 * Math.PI <= g),
                                                S = c / 100,
                                                _ = w ? -1 : Math.min(p * (p < 0 ? 1 : S), v * (v < 0 ? 1 : S)),
                                                M = k ? -1 : Math.min(m * (m < 0 ? 1 : S), y * (y < 0 ? 1 : S)),
                                                C = b ? 1 : Math.max(p * (0 < p ? 1 : S), v * (0 < v ? 1 : S)),
                                                D = x ? 1 : Math.max(m * (0 < m ? 1 : S), y * (0 < y ? 1 : S)),
                                                A = 0.5 * (C - _),
                                                T = 0.5 * (D - M);
                                            (l = Math.min(o / A, s / T)), (u = { x: -0.5 * (C + _), y: -0.5 * (D + M) });
                                        }
                                        (t.borderWidth = n.getMaxBorderWidth(d.data)),
                                            (t.outerRadius = Math.max((l - t.borderWidth) / 2, 0)),
                                            (t.innerRadius = Math.max(c ? (t.outerRadius / 100) * c : 1, 0)),
                                    ...
                                    updateElement: function (t, e, i) {
                                        var n = this,
                                            ...
                                            c = o.rotation,
                                            h = n.getDataset(),
                                            f = i && s.animateRotate ? 0 : t.hidden ? 0 : n.calculateCircumference(h.data[e]) * (o.circumference / (2 * Math.PI)),
                                        ...
                                        var v = t._model;
                                        this.removeHoverStyle(t), (i && s.animateRotate) || ((v.startAngle = 0 === e ? o.rotation : n.getMeta().data[e - 1]._model.endAngle), (v.endAngle = v.startAngle + v.circumference)), t.pivot();
                                    },
                                    removeHoverStyle: function (t) {
                                    ...
                                    getMaxBorderWidth: function (t) {
                                        for (var e, i, n = 0, a = this.index, r = t.length, o = 0; o < r; o++)
                                            n = (n = n < (e = t[o]._model ? t[o]._model.borderWidth : 0) ? e : n) < (i = t[o]._chart ? t[o]._chart.config.data.datasets[a].hoverBorderWidth : 0) ? i : n;
                                        return n;
                                    },
                                }));
                        };
                ...
                18: [
                    function (t, e, i) {
                        ...
                        e.exports = function (a) {
                            ...
                            (a.defaults.line = { showLines: !0, spanGaps: !1, hover: { mode: "label" }, scales: { xAxes: [{ type: "category", id: "x-axis-0" }], yAxes: [{ type: "linear", id: "y-axis-0" }] } }),
                                (a.controllers.line = a.DatasetController.extend({
                                    ...
                                    addElementAndReset: function (t) {
                                        var e = this,
                                            i = e.chart.options,
                                            n = e.getMeta();
                                        a.DatasetController.prototype.addElementAndReset.call(e, t), f(e.getDataset(), i) && 0 !== n.dataset._model.tension && e.updateBezierControlPoints();
                                    },
                                    update: function (t) {
                                        var e,
                                            i,
                                        ...
                                        for (
                                            h &&
                                                ...
                                                (o._model = {
                                                    ...
                                                    tension: n.tension ? n.tension : g.getValueOrDefault(c.lineTension, u.tension),
                                                    ...
                                                    steppedLine: n.steppedLine ? n.steppedLine : g.getValueOrDefault(c.steppedLine, u.stepped),
                                                    scaleTop: d.top,
                                        ...
                                        for (h && 0 !== o._model.tension && a.updateBezierControlPoints(), e = 0, i = s.length; e < i; ++e) s[e].pivot();
                                    },
                                    getPointBackgroundColor: function (t, e) {
                                        var i = this.chart.options.elements.point.backgroundColor,
                                            n = this.getDataset(),
                                            a = t.custom || {};
                                        return a.backgroundColor ? (i = a.backgroundColor) : n.pointBackgroundColor ? (i = g.getValueAtIndexOrDefault(n.pointBackgroundColor, e, i)) : n.backgroundColor && (i = n.backgroundColor), i;
                                    },
                                    getPointBorderColor: function (t, e) {
                                        var i = this.chart.options.elements.point.borderColor,
                                            n = this.getDataset(),
                                            a = t.custom || {};
                                        return a.borderColor ? (i = a.borderColor) : n.pointBorderColor ? (i = g.getValueAtIndexOrDefault(n.pointBorderColor, e, i)) : n.borderColor && (i = n.borderColor), i;
                                    },
                                    getPointBorderWidth: function (t, e) {
                                        var i = this.chart.options.elements.point.borderWidth,
                                            n = this.getDataset(),
                                            a = t.custom || {};
                                        return a.borderWidth ? (i = a.borderWidth) : n.pointBorderWidth ? (i = g.getValueAtIndexOrDefault(n.pointBorderWidth, e, i)) : n.borderWidth && (i = n.borderWidth), i;
                                    },
                                    updateElement: function (t, e, i) {
                                        var n,
                                            a,
                                        ...
                                        void 0 !== l.radius && void 0 === l.pointRadius && (l.pointRadius = l.radius),
                                            ...
                                            (n = h.getPixelForValue("object" == typeof d ? d : NaN, e, u, r.chart.isCombo)),
                                    ...
                                    updateBezierControlPoints: function () {
                                        ...
                                        for (t = 0, e = o.length; t < e; ++t)
                                            (i = o[t]._model),
                                                (n = g.splineCurve(g.previousItem(o, t)._model, i, g.nextItem(o, t)._model, a.dataset._model.tension)),
                                                (i.controlPointPreviousX = l(n.previous.x, r.left, r.right)),
                                                (i.controlPointPreviousY = l(n.previous.y, r.top, r.bottom)),
                                    ...
                                    draw: function (t) {
                                        ...
                                        for (f(this.getDataset(), this.chart.options) && n.dataset.transition(r).draw(), e = 0, i = a.length; e < i; ++e) a[e].draw();
                                    },
                                    setHoverStyle: function (t) {
                                        var e = this.chart.data.datasets[t._datasetIndex],
                                            i = t._index,
                                            n = t.custom || {},
                                            a = t._model;
                                        (a.radius = n.hoverRadius || g.getValueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius)),
                                            (a.backgroundColor = n.hoverBackgroundColor || g.getValueAtIndexOrDefault(e.pointHoverBackgroundColor, i, g.getHoverColor(a.backgroundColor))),
                                            (a.borderColor = n.hoverBorderColor || g.getValueAtIndexOrDefault(e.pointHoverBorderColor, i, g.getHoverColor(a.borderColor))),
                                            (a.borderWidth = n.hoverBorderWidth || g.getValueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth));
                                    },
                                    removeHoverStyle: function (t) {
                                        var e = this,
                                        ...
                                        void 0 !== i.radius && void 0 === i.pointRadius && (i.pointRadius = i.radius),
                                            (r.radius = a.radius || g.getValueAtIndexOrDefault(i.pointRadius, n, e.chart.options.elements.point.radius)),
                            ...
                            (e.defaults.polarArea = {
                                ...
                                legendCallback: function (t) {
                                    ...
                                    var i = t.data,
                                        n = i.datasets,
                                        a = i.labels;
                                    if (n.length) for (var r = 0; r < n[0].data.length; ++r) e.push('<li><span style="background-color:' + n[0].backgroundColor[r] + '">'), a[r] && e.push(a[r]), e.push("</span></li>");
                                    return e.push("</ul>"), e.join("");
                                },
                                legend: {
                                    labels: {
                                        generateLabels: function (s) {
                                            ...
                                            return l.labels.length && l.datasets.length
                                                ? l.labels.map(function (t, e) {
                                                      ...
                                                      return {
                                                          text: t,
                                                          fillStyle: a.backgroundColor ? a.backgroundColor : r(n.backgroundColor, e, o.backgroundColor),
                                                          strokeStyle: a.borderColor ? a.borderColor : r(n.borderColor, e, o.borderColor),
                                                          lineWidth: a.borderWidth ? a.borderWidth : r(n.borderWidth, e, o.borderWidth),
                                                          hidden: isNaN(n.data[e]) || i.data[e].hidden,
                                                          index: e,
                                                      };
                                                  })
                                ...
                                (e.controllers.polarArea = e.DatasetController.extend({
                                    ...
                                    updateElement: function (t, e, i) {
                                        ...
                                        k.extend(t, {
                                            ...
                                            _index: e,
                                            _scale: l,
                                            _model: { x: h, y: f, innerRadius: 0, outerRadius: i ? w : y, startAngle: i && s.animateRotate ? v : b, endAngle: i && s.animateRotate ? v : x, label: u(d, e, d[e]) },
                                        }),
                ...
                20: [
                    function (t, e, i) {
                        ...
                        e.exports = function (e) {
                            var u = e.helpers;
                            (e.defaults.radar = { scale: { type: "radialLinear" }, elements: { line: { tension: 0 } } }),
                                (e.controllers.radar = e.DatasetController.extend({
                                    datasetElementType: e.elements.Line,
                                    dataElementType: e.elements.Point,
                                    linkScales: u.noop,
                                    addElementAndReset: function (t) {
                                        e.DatasetController.prototype.addElementAndReset.call(this, t), this.updateBezierControlPoints();
                                    },
                                    update: function (i) {
                                        var n = this,
                                            t = n.getMeta(),
                                        ...
                                        void 0 !== o.tension && void 0 === o.lineTension && (o.lineTension = o.tension),
                                            u.extend(t.dataset, {
                                                ...
                                                _loop: !0,
                                                _model: {
                                                    tension: r.tension ? r.tension : u.getValueOrDefault(o.lineTension, s.tension),
                                    ...
                                    updateElement: function (t, e, i) {
                                        ...
                                        u.extend(t, {
                                            ...
                                            _model: {
                                                x: i ? o.xCenter : l.x,
                                                y: i ? o.yCenter : l.y,
                                                tension: a.tension ? a.tension : u.getValueOrDefault(r.tension, n.chart.options.elements.line.tension),
                                                radius: a.radius ? a.radius : u.getValueAtIndexOrDefault(r.pointRadius, e, s.radius),
                                                backgroundColor: a.backgroundColor ? a.backgroundColor : u.getValueAtIndexOrDefault(r.pointBackgroundColor, e, s.backgroundColor),
                                                borderColor: a.borderColor ? a.borderColor : u.getValueAtIndexOrDefault(r.pointBorderColor, e, s.borderColor),
                                                borderWidth: a.borderWidth ? a.borderWidth : u.getValueAtIndexOrDefault(r.pointBorderWidth, e, s.borderWidth),
                                                pointStyle: a.pointStyle ? a.pointStyle : u.getValueAtIndexOrDefault(r.pointStyle, e, s.pointStyle),
                                                hitRadius: a.hitRadius ? a.hitRadius : u.getValueAtIndexOrDefault(r.hitRadius, e, s.hitRadius),
                                            },
                                        }),
                                    ...
                                    setHoverStyle: function (t) {
                                        var e = this.chart.data.datasets[t._datasetIndex],
                                            ...
                                            n = t._index,
                                            a = t._model;
                                        (a.radius = i.hoverRadius ? i.hoverRadius : u.getValueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius)),
                                            (a.backgroundColor = i.hoverBackgroundColor ? i.hoverBackgroundColor : u.getValueAtIndexOrDefault(e.pointHoverBackgroundColor, n, u.getHoverColor(a.backgroundColor))),
                                            (a.borderColor = i.hoverBorderColor ? i.hoverBorderColor : u.getValueAtIndexOrDefault(e.pointHoverBorderColor, n, u.getHoverColor(a.borderColor))),
                                            (a.borderWidth = i.hoverBorderWidth ? i.hoverBorderWidth : u.getValueAtIndexOrDefault(e.pointHoverBorderWidth, n, a.borderWidth));
                                    },
                                    removeHoverStyle: function (t) {
                                        var e = this.chart.data.datasets[t._datasetIndex],
                                            i = t.custom || {},
                                        ...
                                        (a.radius = i.radius ? i.radius : u.getValueAtIndexOrDefault(e.radius, n, r.radius)),
                                            (a.backgroundColor = i.backgroundColor ? i.backgroundColor : u.getValueAtIndexOrDefault(e.pointBackgroundColor, n, r.backgroundColor)),
                                            (a.borderColor = i.borderColor ? i.borderColor : u.getValueAtIndexOrDefault(e.pointBorderColor, n, r.borderColor)),
                                            (a.borderWidth = i.borderWidth ? i.borderWidth : u.getValueAtIndexOrDefault(e.pointBorderWidth, n, r.borderWidth));
                                    },
                                }));
                        };
                    },
                            ...
                            (t.defaults.global.animation = { duration: 1e3, easing: "easeOutQuart", onProgress: i.noop, onComplete: i.noop }),
                                ...
                                (t.animationService = {
                                    ...
                                    addAnimation: function (t, e, i, n) {
                                        var a = this;
                                        n || (t.animating = !0);
                                        for (var r = 0; r < a.animations.length; ++r) if (a.animations[r].chartInstance === t) return void (a.animations[r].animationObject = e);
                                    ...
                                    startDigest: function () {
                                        ...
                                        for (var n = 0; n < t.animations.length; )
                                            null === t.animations[n].animationObject.currentStep && (t.animations[n].animationObject.currentStep = 0),
                                                ...
                                                t.animations[n].animationObject.currentStep > t.animations[n].animationObject.numSteps && (t.animations[n].animationObject.currentStep = t.animations[n].animationObject.numSteps),
                                        ...
                                        (t.dropFrames += a), 0 < t.animations.length && t.requestAnimationFrame();
                                    },
                                });
                        };
                    },
                            ...
                            (l.types = {}),
                                ...
                                (l.Controller = function (t) {
                                    return (
                                        ...
                                        (this.options = this.config.options = u.configMerge(l.defaults.global, l.defaults[this.config.type], this.config.options || {})),
                                        (this.id = u.uid()),
                                        ...
                                        (l.instances[this.id] = this).options.responsive && this.resize(!0),
                                        this.initialize(),
                                        this
                                    );
                                }),
                                u.extend(l.Controller.prototype, {
                                    ...
                                    resize: function (t) {
                                        var e = this,
                                            ...
                                            r = i.aspectRatio,
                                            o = e.options.maintainAspectRatio && !1 === isNaN(r) && isFinite(r) && 0 !== r ? a / r : u.getMaximumHeight(n);
                                        if (!(i.width !== a || i.height !== o)) return e;
                                        (n.width = i.width = a), (n.height = i.height = o), u.retinaScale(i);
                                        var s = { width: a, height: o };
                                        return l.plugins.notify("resize", [e, s]), e.options.onResize && e.options.onResize(e, s), t || (e.stop(), e.update(e.options.responsiveAnimationDuration)), e;
                                    },
                                    ...
                                    buildScales: function () {
                                        ...
                                        t.scales &&
                                            ...
                                            u.each(e, function (t) {
                                                ...
                                                if (n) {
                                                    var a = new n({ id: e.id, options: e, ctx: r.chart.ctx, chart: r });
                                    ...
                                    updateLayout: function () {
                                        l.layoutService.update(this, this.chart.width, this.chart.height);
                                    },
                                        ...
                                        if (
                                            (u.each(
                                                ...
                                                function (t, e) {
                                                    ...
                                                    i.type || (i.type = t.type || n.config.type), a.push(i.type), i.controller ? i.controller.updateIndex(e) : ((i.controller = new l.controllers[i.type](n, e)), r.push(i.controller));
                                                },
                                                n
                                            ),
                                            1 < a.length)
                                    ...
                                    update: function (t, e) {
                                        var i = this;
                                        l.plugins.notify("beforeUpdate", [i]), (i.tooltip._data = i.data);
                                            ...
                                            o = function () {
                                                if (n.data.datasets)
                                                    for (var t = 0; t < n.data.datasets.length; t++) {
                                                        ...
                                                        if (n.isDatasetVisible(t)) for (var i = 0; i < e.data.length; i++) if (e.data[i].inRange(a.x, a.y)) return e.data[i];
                                                    }
                                            }.call(n);
                                        return (
                                            o &&
                                            ...
                                            o = function () {
                                                if (a.data.datasets)
                                                    for (var t = 0; t < a.data.datasets.length; t++) {
                                                        ...
                                                        if (a.isDatasetVisible(t)) for (var i = 0; i < e.data.length; i++) if (e.data[i].inLabelRange(n.x, n.y)) return e.data[i];
                                                    }
                                            }.call(a);
                                        return (
                                            o &&
                                                u.each(
                                                    ...
                                                    function (t, e) {
                                                        if (a.isDatasetVisible(e)) {
                                                            ...
                                                            -1 === n || i.data[n]._view.skip || r.push(i.data[n]);
                                                        }
                                                    },
                                                    a
                                                ),
                                    ...
                                    getDatasetAtEvent: function (t) {
                                        ...
                                        return 0 < e.length && (e = this.getDatasetMeta(e[0]._datasetIndex).data), e;
                                    },
                                    ...
                                    destroy: function () {
                                        var t = this;
                                        t.stop(), t.clear(), u.unbindEvents(t, t.events), u.removeResizeListener(t.chart.canvas.parentNode);
                                        var e = t.chart.canvas;
                                        (e.width = t.chart.width),
                                            (e.height = t.chart.height),
                                            void 0 !== t.chart.originalDevicePixelRatio && t.chart.ctx.scale(1 / t.chart.originalDevicePixelRatio, 1 / t.chart.originalDevicePixelRatio),
                                    ...
                                    initToolTip: function () {
                                        var t = this;
                                        t.tooltip = new l.Tooltip({ _chart: t.chart, _chartInstance: t, _data: t.data, _options: t.options.tooltips }, t);
                                    },
                                    bindEvents: function () {
                                        var e = this;
                                    ...
                                    eventHandler: function (t) {
                                        ...
                                        return (
                                            ...
                                            "mouseout" === t.type ? ((e.active = []), (e.tooltipActive = [])) : ((e.active = e.getElementsAtEventForMode(t, a.mode)), (e.tooltipActive = e.getElementsAtEventForMode(t, r.mode))),
                                            a.onHover && a.onHover.call(e, e.active),
                                            ("mouseup" !== t.type && "click" !== t.type) || (n.onClick && n.onClick.call(e, t, e.active), e.legend && e.legend.handleEvent && e.legend.handleEvent(t)),
                                            e.lastActive.length && e.updateHoverStyle(e.lastActive, a.mode, !1),
                                            e.active.length && a.mode && e.updateHoverStyle(e.active, a.mode, !0),
                                            (r.enabled || r.custom) && (i.initialize(), (i._active = e.tooltipActive), i.update(!0)),
                                            i.pivot(),
                                            e.animating ||
                                                (u.arrayEquals(e.active, e.lastActive) && u.arrayEquals(e.tooltipActive, e.lastTooltipActive)) ||
                                                (e.stop(), (r.enabled || r.custom) && i.update(!0), e.render(a.animationDuration, !0)),
                                ...
                                s.extend(t.DatasetController.prototype, {
                                    ...
                                    addElements: function () {
                                        var t,
                                            ...
                                            a = i.data;
                                        for (t = 0, e = n.length; t < e; ++t) a[t] = a[t] || this.createMetaData(i, t);
                                    ...
                                    buildOrUpdateElements: function () {
                                        ...
                                        else if (i < e) for (var n = i; n < e; ++n) this.addElementAndReset(n);
                                    },
                                    update: e,
                                    draw: function (t) {
                                        var e = t || 1;
                                    ...
                                    removeHoverStyle: function (t, e) {
                                        var i = this.chart.data.datasets[t._datasetIndex],
                                            ...
                                            o = t._model;
                                        (o.backgroundColor = a.backgroundColor ? a.backgroundColor : r(i.backgroundColor, n, e.backgroundColor)),
                                            (o.borderColor = a.borderColor ? a.borderColor : r(i.borderColor, n, e.borderColor)),
                                            (o.borderWidth = a.borderWidth ? a.borderWidth : r(i.borderWidth, n, e.borderWidth));
                                    },
                                    setHoverStyle: function (t) {
                                        var e = this.chart.data.datasets[t._datasetIndex],
                                            i = t._index,
                                            ...
                                            r = s.getHoverColor,
                                            o = t._model;
                                        (o.backgroundColor = n.hoverBackgroundColor ? n.hoverBackgroundColor : a(e.hoverBackgroundColor, i, r(o.backgroundColor))),
                                            (o.borderColor = n.hoverBorderColor ? n.hoverBorderColor : a(e.hoverBorderColor, i, r(o.borderColor))),
                                            (o.borderWidth = n.hoverBorderWidth ? n.hoverBorderWidth : a(e.hoverBorderWidth, i, o.borderWidth));
                                    },
                                }),
                        ...
                        e.exports = function (t) {
                            ...
                            (t.elements = {}),
                                ...
                                o.extend(t.Element.prototype, {
                                    ...
                                    pivot: function () {
                                        var t = this;
                                        return t._view || (t._view = o.clone(t._model)), (t._start = o.clone(t._view)), t;
                                    },
                                                      ...
                                                      function (e, i) {
                                                          if ("_" === i[0]);
                                                              ...
                                                              if (e === r._view[i]);
                                                                  ...
                                                                  try {
                                                                      var t = o.color(r._model[i]).mix(o.color(r._start[i]), a);
                                                          ...
                                                          else "number" != typeof e || isNaN(r._view[i]) ? (r._view[i] = e) : (r._view[i] = e * a);
                                                      },
                                                      r
                                                  )),
                                            r
                        ...
                        e.exports = function (o) {
                            ...
                            (g.each = function (t, e, i, n) {
                                ...
                                (g.clone = function (t) {
                                    ...
                                    return (
                                        g.each(t, function (t, e) {
                                            g.isArray(t) ? (i[e] = t.slice(0)) : (i[e] = "object" == typeof t && null !== t ? g.clone(t) : t);
                                        }),
                                        i
                                    );
                                }),
                                ...
                                (g.configMerge = function (t) {
                                    var n = g.clone(t);
                                    return (
                                        g.each(Array.prototype.slice.call(arguments, 1), function (t) {
                                            g.each(t, function (t, e) {
                                                if ("scales" === e) n[e] = g.scaleMerge(n.hasOwnProperty(e) ? n[e] : {}, t);
                                                else if ("scale" === e) n[e] = g.configMerge(n.hasOwnProperty(e) ? n[e] : {}, o.scaleService.getScaleDefaults(t.type), t);
                                                else if (n.hasOwnProperty(e) && g.isArray(n[e]) && g.isArray(t)) {
                                                    var i = n[e];
                                                    g.each(t, function (t, e) {
                                                        e < i.length ? ("object" == typeof i[e] && null !== i[e] && "object" == typeof t && null !== t ? (i[e] = g.configMerge(i[e], t)) : (i[e] = t)) : i.push(t);
                                                    });
                                                } else n.hasOwnProperty(e) && "object" == typeof n[e] && null !== n[e] && "object" == typeof t ? (n[e] = g.configMerge(n[e], t)) : (n[e] = t);
                                            });
                                        }),
                                        n
                                    );
                                    ...
                                    return (
                                        g.each(e, function (t, a) {
                                            "xAxes" === a || "yAxes" === a
                                                ? r.hasOwnProperty(a)
                                                    ? g.each(t, function (t, e) {
                                                          var i = g.getValueOrDefault(t.type, "xAxes" === a ? "category" : "linear"),
                                                    ...
                                                    : ((r[a] = []),
                                                      g.each(t, function (t) {
                                                          var e = g.getValueOrDefault(t.type, "xAxes" === a ? "category" : "linear");
                                                          r[a].push(g.configMerge(o.scaleService.getScaleDefaults(e), t));
                                                      }))
                                                : r.hasOwnProperty(a) && "object" == typeof r[a] && null !== r[a] && "object" == typeof t
                                ...
                                (g.getValueAtIndexOrDefault = function (t, e, i) {
                                    return null == t ? i : g.isArray(t) ? (e < t.length ? t[e] : i) : t;
                                }),
                                ...
                                (g.inherits = function (t) {
                                    ...
                                    return (n.prototype = e.prototype), (i.prototype = new n()), (i.extend = g.inherits), t && g.extend(i.prototype, t), (i.__super__ = e.prototype), i;
                                }),
                                (g.noop = function () {}),
                                (g.uid =
                                    ((t = 0),
                            ...
                            var e = (g.easingEffects = {
                                ...
                                easeInElastic: function (t) {
                                    ...
                                    return 0 === t
                                        ...
                                        : 1 == (t /= 1)
                                        ? 1
                                        : (i || (i = 0.3), (e = n < Math.abs(1) ? ((n = 1), i / 4) : (i / (2 * Math.PI)) * Math.asin(1 / n)), -n * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i));
                                },
                                easeOutElastic: function (t) {
                                    ...
                                    return 0 === t
                                        ...
                                        : 1 == (t /= 1)
                                        ? 1
                                        : (i || (i = 0.3), (e = n < Math.abs(1) ? ((n = 1), i / 4) : (i / (2 * Math.PI)) * Math.asin(1 / n)), n * Math.pow(2, -10 * t) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i) + 1);
                                },
                                easeInOutElastic: function (t) {
                                    ...
                                    return 0 === t
                                        ...
                                        : (i || (i = 0.3 * 1.5 * 1),
                                          ...
                                          t < 1 ? n * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i) * -0.5 : n * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i) * 0.5 + 1);
                                },
                                ...
                                easeInOutBounce: function (t) {
                                    return t < 0.5 ? 0.5 * e.easeInBounce(2 * t) : 0.5 * e.easeOutBounce(2 * t - 1) + 0.5;
                                },
                            });
                            function d(t, e, i) {
                                var n;
                            ...
                            function i(t, e, i) {
                                ...
                                return s || l ? Math.min(s ? d(r, t, i) : u, l ? d(o, a, i) : u) : "none";
                            }
                            (g.requestAnimFrame =
                                ...
                                (g.getRelativePosition = function (t, e) {
                                    ...
                                    return { x: (i = Math.round((((i - o.left - l) / h) * r.width) / e.currentDevicePixelRatio)), y: (n = Math.round((((n - o.top - u) / f) * r.height) / e.currentDevicePixelRatio)) };
                                }),
                                (g.addEvent = function (t, e, i) {
                                    t.addEventListener ? t.addEventListener(e, i) : t.attachEvent ? t.attachEvent("on" + e, i) : (t["on" + e] = i);
                                }),
                                (g.removeEvent = function (t, e, i) {
                                    t.removeEventListener ? t.removeEventListener(e, i, !1) : t.detachEvent ? t.detachEvent("on" + e, i) : (t["on" + e] = g.noop);
                                }),
                                ...
                                (g.getMaximumWidth = function (t) {
                                    var e = t.parentNode,
                                        i = parseInt(g.getStyle(e, "padding-left")) + parseInt(g.getStyle(e, "padding-right")),
                                        n = e.clientWidth - i,
                                ...
                                (g.getMaximumHeight = function (t) {
                                    var e = t.parentNode,
                                        i = parseInt(g.getStyle(e, "padding-top")) + parseInt(g.getStyle(e, "padding-bottom")),
                                        n = e.clientHeight - i,
                                ...
                                (g.retinaScale = function (t) {
                                    ...
                                    1 !== r && ((i.height = a * r), (i.width = n * r), e.scale(r, r), (t.originalDevicePixelRatio = t.originalDevicePixelRatio || r)), (i.style.width = n + "px"), (i.style.height = a + "px");
                                }),
                                (g.clear = function (t) {
                                ...
                                (g.color = function (t) {
                                    return n ? (t instanceof CanvasGradient ? n(o.defaults.global.defaultColor) : n(t)) : (console.log("Color.js not found!"), t);
                                }),
                        ...
                        e.exports = function () {
                            var a = function (t, e) {
                                ...
                                return (
                                    ...
                                    (i.width = t.canvas.width || parseInt(n.getStyle(t.canvas, "width"), 10) || n.getMaximumWidth(t.canvas)),
                                    (i.height = t.canvas.height || parseInt(n.getStyle(t.canvas, "height"), 10) || n.getMaximumHeight(t.canvas)),
                                    (i.aspectRatio = i.width / i.height),
                                    (isNaN(i.aspectRatio) || !1 === isFinite(i.aspectRatio)) && (i.aspectRatio = void 0 !== e.aspectRatio ? e.aspectRatio : 2),
                                ...
                                update: function (e, i, t) {
                                    if (e) {
                                        ...
                                        C.each(n.concat(a, r, o), function (t) {
                                            var e,
                                                i = t.isHorizontal();
                                            i ? ((e = t.update(t.options.fullWidth ? l : f, h)), (g -= e.height)) : ((e = t.update(c, d)), (f -= e.width));
                                        ...
                                        C.each(n.concat(r), M),
                                            ...
                                            C.each(a, M),
                                            C.each(o, M),
                                            (e.chartArea = { left: m, top: y, right: m + f, bottom: y + g }),
                                            C.each(s, function (t) {
                                                (t.left = e.chartArea.left), (t.top = e.chartArea.top), (t.right = e.chartArea.right), (t.bottom = e.chartArea.bottom), t.update(f, g);
                                            });
                                    }
                                    function _(e) {
                                        var t = C.findNextWhere(p, function (t) {
                                    ...
                                    function M(t) {
                                        t.isHorizontal()
                                            ? ((t.left = t.options.fullWidth ? 0 : m), (t.right = t.options.fullWidth ? i - 0 : m + f), (t.top = S), (t.bottom = S + t.height), (S = t.bottom))
                                            : ((t.left = k), (t.right = k + t.width), (t.top = y), (t.bottom = y + g), (k = t.right));
                                    }
                                },
                            };
                        };
                            ...
                            (M.defaults.global.legend = {
                                ...
                                (M.Legend = M.Element.extend({
                                            ...
                                            if (((r.font = d), f)) {
                                                ...
                                                (r.textAlign = "left"),
                                                    ...
                                                    C.each(n.legendItems, function (t, e) {
                                                        var i = (a.usePointStyle ? s * Math.sqrt(2) : a.boxWidth) + s / 2 + r.measureText(t.text).width;
                                                ...
                                                var m = a.padding,
                                                    ...
                                                    w = s + m;
                                                C.each(n.legendItems, function (t, e) {
                                                    var i = (a.usePointStyle ? 2 * a.boxWidth : a.boxWidth) + s / 2 + r.measureText(t.text).width;
                                                    x + w > h.height && ((y += b + a.padding), v.push(b), (x = b = 0)), (b = Math.max(b, i)), (x += w), (c[e] = { left: 0, top: 0, width: i, height: s });
                                                }),
                                                    (y += b),
                                                    v.push(b),
                                                    (h.width += y);
                                    ...
                                    draw: function () {
                                        ...
                                        if (c.display) {
                                            ...
                                            (y.textAlign = "left"), (y.textBaseline = "top"), (y.lineWidth = 0.5), (y.strokeStyle = t), (y.fillStyle = t), (y.font = n);
                                            var w = h.boxWidth,
                                                k = d.legendHitBoxes,
                                                S = d.isHorizontal();
                                            v = S ? { x: d.left + (p - m[0]) / 2, y: d.top + h.padding, line: 0 } : { x: d.left + h.padding, y: d.top + h.padding, line: 0 };
                                            var _ = x + h.padding;
                                            C.each(d.legendItems, function (t, e) {
                                                var i,
                                                    ...
                                                    l = v.x,
                                                    u = v.y;
                                                S ? p <= l + s && ((u = v.y += _), v.line++, (l = v.x = d.left + (p - m[v.line]) / 2)) : u + _ > d.bottom && ((l = v.x = l + d.columnWidths[v.line] + h.padding), (u = v.y = d.top), v.line++),
                                                    (function (t, e, i) {
                                                        if (!(isNaN(w) || w <= 0)) {
                                                            if (
                                                                (y.save(),
                                                                ...
                                                                (y.lineDashOffset = b(i.lineDashOffset, g.borderDashOffset)),
                                                                (y.lineJoin = b(i.lineJoin, g.borderJoinStyle)),
                                                                (y.lineWidth = b(i.lineWidth, g.borderWidth)),
                                                                (y.strokeStyle = b(i.strokeStyle, f.defaultColor)),
                                                                y.setLineDash && y.setLineDash(b(i.lineDash, g.borderDash)),
                                                                ...
                                                                var n = (x * Math.SQRT2) / 2,
                                                                    ...
                                                                    r = t + a,
                                                                    o = e + a;
                                                                M.canvasHelpers.drawPoint(y, i.pointStyle, n, r, o);
                                                            } else y.strokeRect(t, e, w, x), y.fillRect(t, e, w, x);
                                                            y.restore();
                                                        }
                                                    })(l, u, t),
                                                    (k[e].left = l),
                                                    ...
                                                    a.hidden && (y.beginPath(), (y.lineWidth = 2), y.moveTo(w + x / 2 + i, n + x / 2), y.lineTo(w + x / 2 + i + r, n + x / 2), y.stroke()),
                                    ...
                                    handleEvent: function (t) {
                                        var e = C.getRelativePosition(t, this.chart.chart),
                                            ...
                                            n = e.y,
                                            a = this.options;
                                        if (i >= this.left && i <= this.right && n >= this.top && n <= this.bottom)
                                            for (var r = this.legendHitBoxes, o = 0; o < r.length; ++o) {
                                                var s = r[o];
                                                if (i >= s.left && i <= s.left + s.width && n >= s.top && n <= s.top + s.height) {
                                                    a.onClick && a.onClick.call(this, t, this.legendItems[o]);
                                                    break;
                                                }
                                            }
                                    },
                                ...
                                M.plugins.register({
                                    beforeInit: function (t) {
                                        ...
                                        e && ((t.legend = new M.Legend({ ctx: t.chart.ctx, options: e, chart: t })), M.layoutService.addBox(t, t.legend));
                                    },
                                });
                        };
                    },
                            ...
                            (t.plugins = {
                                ...
                                notify: function (t, e) {
                                    var i,
                                        ...
                                        a = this._plugins,
                                        r = a.length;
                                    for (i = 0; i < r; ++i) if ("function" == typeof (n = a[i])[t] && !1 === n[t].apply(n, e || [])) return !1;
                                    return !0;
                                },
                            }),
                                (t.PluginBase = t.Element.extend({ beforeInit: e, afterInit: e, beforeUpdate: e, afterUpdate: e, beforeDraw: e, afterDraw: e, destroy: e })),
                                ...
                                (N.Scale = N.Element.extend({
                                    ...
                                    update: function (t, e, i) {
                                        ...
                                        return (
                                            ...
                                            (n.maxWidth = t),
                                            (n.maxHeight = e),
                                            (n.margins = Y.extend({ left: 0, right: 0, top: 0, bottom: 0 }, i)),
                                            n.beforeSetDimensions(),
                                            n.setDimensions(),
                                            n.afterSetDimensions(),
                                            n.beforeDataLimits(),
                                    ...
                                    beforeTickToLabelConversion: function () {
                                        Y.callCallback(this.options.beforeTickToLabelConversion, [this]);
                                    },
                                    convertTicksToLabels: function () {
                                        var n = this;
                                        n.ticks = n.ticks.map(function (t, e, i) {
                                            return n.options.ticks.userCallback ? n.options.ticks.userCallback(t, e, i) : n.options.ticks.callback(t, e, i);
                                        }, n);
                                    },
                                    afterTickToLabelConversion: function () {
                                        Y.callCallback(this.options.afterTickToLabelConversion, [this]);
                                    },
                                    beforeCalculateTickRotation: function () {
                                        Y.callCallback(this.options.beforeCalculateTickRotation, [this]);
                                    },
                                    calculateTickRotation: function () {
                                        var t = this,
                                            ...
                                            o = Y.getValueOrDefault(n.fontFamily, i.defaultFontFamily),
                                        ...
                                        if (((t.labelRotation = n.minRotation || 0), (t.paddingRight = 0), (t.paddingLeft = 0), t.options.display && t.isHorizontal())) {
                                            (t.paddingRight = d / 2 + 3), (t.paddingLeft = u / 2 + 3), t.longestTextCache || (t.longestTextCache = {});
                                            for (var c, h, f = Y.longestText(e, s, t.ticks, t.longestTextCache), g = f, p = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; p < g && t.labelRotation < n.maxRotation; ) {
                                                if (
                                                    ((c = Math.cos(Y.toRadians(t.labelRotation))),
                                                    (h = Math.sin(Y.toRadians(t.labelRotation))),
                                                    (l = c * u) + a / 2 > t.yLabelWidth && (t.paddingLeft = l + a / 2),
                                                    (t.paddingRight = a / 2),
                                                    h * f > t.maxHeight)
                                                ) {
                                                    t.labelRotation--;
                                    ...
                                    afterCalculateTickRotation: function () {
                                        Y.callCallback(this.options.afterCalculateTickRotation, [this]);
                                    },
                                    beforeFit: function () {
                                    ...
                                    fit: function () {
                                        var t = this,
                                            ...
                                            d = Y.getValueOrDefault(a.fontFamily, n.defaultFontFamily),
                                            c = Y.fontString(l, u, d),
                                            h = Y.getValueOrDefault(r.fontSize, n.defaultFontSize),
                                            f = i.gridLines.tickMarkLength;
                                        if (
                                            ((e.width = s ? (t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth) : o ? f : 0),
                                            (e.height = s ? (o ? f : 0) : t.maxHeight),
                                            r.display && o && (s ? (e.height += 1.5 * h) : (e.width += 1.5 * h)),
                                            a.display && o)
                                        ) {
                                            t.longestTextCache || (t.longestTextCache = {});
                                            var g = Y.longestText(t.ctx, c, t.ticks, t.longestTextCache),
                                                p = Y.numberOfLabelLines(t.ticks),
                                                m = 0.5 * l;
                                            if (s) {
                                                t.longestLabelWidth = g;
                                                var v = Math.sin(Y.toRadians(t.labelRotation)) * t.longestLabelWidth + l * p + m * p;
                                                (e.height = Math.min(t.maxHeight, e.height + v)), (t.ctx.font = c);
                                                var y = t.ctx.measureText(t.ticks[0]).width,
                                                    b = t.ctx.measureText(t.ticks[t.ticks.length - 1]).width,
                                                    x = Math.cos(Y.toRadians(t.labelRotation)),
                                                    w = Math.sin(Y.toRadians(t.labelRotation));
                                                (t.paddingLeft = 0 !== t.labelRotation ? x * y + 3 : y / 2 + 3), (t.paddingRight = 0 !== t.labelRotation ? w * (l / 2) + 3 : b / 2 + 3);
                                            } else {
                                                var k = t.maxWidth - e.width;
                                                a.mirror ? (g = 0) : (g += t.options.ticks.padding), g < k ? (e.width += g) : (e.width = t.maxWidth), (t.paddingTop = l / 2), (t.paddingBottom = l / 2);
                                            }
                                        }
                                        t.margins &&
                                    ...
                                    getRightValue: function (t) {
                                        return null == t ? NaN : "number" == typeof t && isNaN(t) ? NaN : "object" == typeof t ? (t instanceof Date || t.isValid ? t : this.getRightValue(this.isHorizontal() ? t.x : t.y)) : t;
                                    },
                                    ...
                                    draw: function (b) {
                                        ...
                                        if (w.display) {
                                            ...
                                            var r = Y.getValueOrDefault(S.fontColor, e.defaultFontColor),
                                                o = Y.getValueOrDefault(S.fontSize, e.defaultFontSize),
                                                s = Y.getValueOrDefault(S.fontStyle, e.defaultFontStyle),
                                                l = Y.getValueOrDefault(S.fontFamily, e.defaultFontFamily),
                                                u = Y.fontString(o, s, l),
                                                D = _.tickMarkLength,
                                                d = Y.getValueOrDefault(i.fontColor, e.defaultFontColor),
                                                c = Y.getValueOrDefault(i.fontSize, e.defaultFontSize),
                                                h = Y.getValueOrDefault(i.fontStyle, e.defaultFontStyle),
                                                f = Y.getValueOrDefault(i.fontFamily, e.defaultFontFamily),
                                            ...
                                            if (C) {
                                                if (
                                                    ((k = !1),
                                                    M && (m /= 2),
                                                    (m + S.autoSkipPadding) * x.ticks.length > x.width - (x.paddingLeft + x.paddingRight) &&
                                                        (k = 1 + Math.floor(((m + S.autoSkipPadding) * x.ticks.length) / (x.width - (x.paddingLeft + x.paddingRight)))),
                                                    t && x.ticks.length > t)
                                                )
                                                    for (; !k || x.ticks.length / (k || 1) > t; ) k || (k = 1), (k += 1);
                                                n || (k = !1);
                                            }
                                            ...
                                            if (
                                                (Y.each(x.ticks, function (t, e) {
                                                    if (null != t) {
                                                        ...
                                                        if ((!((1 < k && 0 < e % k) || (e % k == 0 && e + k >= x.ticks.length)) || i) && null != t) {
                                                            var n, a, r, o, s, l, u, d, c, h, f, g;
                                                            a =
                                                                e === (void 0 !== x.zeroLineIndex ? x.zeroLineIndex : 0)
                                                                    ? ((n = _.zeroLineWidth), _.zeroLineColor)
                                                                    : ((n = Y.getValueAtIndexOrDefault(_.lineWidth, e)), Y.getValueAtIndexOrDefault(_.color, e));
                                                            var p,
                                                                m = "middle";
                                                            if (C) {
                                                                M || (m = "top" === w.position ? "bottom" : "top"), (p = M ? "right" : "center");
                                                                var v = x.getPixelForTick(e) + Y.aliasPixel(n);
                                                                (f = x.getPixelForTick(e, _.offsetGridLines) + S.labelOffset),
                                                                    (g = M ? x.top + 12 : "top" === w.position ? x.bottom - D : x.top + D),
                                                                    (r = s = u = c = v),
                                                                    (o = O),
                                                                    (l = F),
                                                                    (d = b.top),
                                                                ...
                                                                (y += Y.aliasPixel(n)), (g = x.getPixelForTick(e, _.offsetGridLines)), (r = P), (s = I), (u = b.left), (c = b.right), (o = l = d = h = y);
                                                            }
                                                            T.push({ tx1: r, ty1: o, tx2: s, ty2: l, x1: u, y1: d, x2: c, y2: h, labelX: f, labelY: g, glWidth: n, glColor: a, rotation: -1 * A, label: t, textBaseline: m, textAlign: p });
                                                        }
                                                    }
                                                }),
                                                Y.each(T, function (t) {
                                                    if (
                                                        (_.display &&
                                                            ...
                                                            a.beginPath(),
                                                            _.drawTicks && (a.moveTo(t.tx1, t.ty1), a.lineTo(t.tx2, t.ty2)),
                                                            _.drawOnChartArea && (a.moveTo(t.x1, t.y1), a.lineTo(t.x2, t.y2)),
                                                            a.stroke()),
                                                        S.display)
                                                    ) {
                                                        a.save(), a.translate(t.labelX, t.labelY), a.rotate(t.rotation), (a.font = u), (a.textBaseline = t.textBaseline), (a.textAlign = t.textAlign);
                                                        var e = t.label;
                                                        if (Y.isArray(e)) for (var i = 0, n = 0; i < e.length; ++i) a.fillText("" + e[i], 0, n), (n += 1.5 * o);
                                                ...
                                                var v,
                                                    y,
                                                    L = 0;
                                                if (C) (v = x.left + (x.right - x.left) / 2), (y = "bottom" === w.position ? x.bottom - c / 2 : x.top + c / 2);
                                                else {
                                                    var R = "left" === w.position;
                                                    (v = R ? x.left + c / 2 : x.right - c / 2), (y = x.top + (x.bottom - x.top) / 2), (L = R ? -0.5 * Math.PI : 0.5 * Math.PI);
                                                }
                                                a.save(), a.translate(v, y), a.rotate(L), (a.textAlign = "center"), (a.textBaseline = "middle"), (a.fillStyle = d), (a.font = g), a.fillText(i.labelString, 0, 0), a.restore();
                                            }
                                            if (_.drawBorder) {
                                                (a.lineWidth = Y.getValueAtIndexOrDefault(_.lineWidth, 0)), (a.strokeStyle = Y.getValueAtIndexOrDefault(_.color, 0));
                                                var V = x.left,
                                                    W = x.right,
                                                    z = x.top,
                                                    E = x.bottom,
                                                    B = Y.aliasPixel(a.lineWidth);
                                                C ? ((z = E = "top" === w.position ? x.bottom : x.top), (z += B), (E += B)) : ((V = W = "left" === w.position ? x.right : x.left), (V += B), (W += B)),
                                                    a.beginPath(),
                                                    a.moveTo(V, z),
                                                    a.lineTo(W, E),
                                                    a.stroke();
                ...
                33: [
                    function (t, e, i) {
                        ...
                        e.exports = function (p) {
                            var m = p.helpers;
                            p.defaults.global.title = { display: !1, position: "top", fullWidth: !0, fontStyle: "bold", padding: 10, text: "" };
                            var t = m.noop;
                            (p.Title = p.Element.extend({
                                initialize: function (t) {
                                    m.extend(this, t), (this.options = m.configMerge(p.defaults.global.title, t.options)), (this.legendHitBoxes = []);
                                },
                                beforeUpdate: function () {
                                    var t = this.chart.options;
                                    t && t.title && (this.options = m.configMerge(p.defaults.global.title, t.title));
                                },
                                update: function (t, e, i) {
                                    var n = this;
                                    return (
                                ...
                                fit: function () {
                                    var t = m.getValueOrDefault,
                                        ...
                                        r = this.minSize;
                                    this.isHorizontal() ? ((r.width = this.maxWidth), (r.height = n ? a + 2 * e.padding : 0)) : ((r.width = n ? a + 2 * e.padding : 0), (r.height = this.maxHeight)),
                                        (this.width = r.width),
                                ...
                                draw: function () {
                                    ...
                                    if (i.display) {
                                        ...
                                        (t.fillStyle = e(i.fontColor, n.defaultFontColor)),
                                            ...
                                            this.isHorizontal()
                                                ? ((a = h + (g - h) / 2), (r = c + (f - c) / 2))
                                                : ((a = "left" === i.position ? h + o / 2 : g - o / 2), (r = c + (f - c) / 2), (d = Math.PI * ("left" === i.position ? -0.5 : 0.5))),
                                            t.save(),
                                            t.translate(a, r),
                                            t.rotate(d),
                                            (t.textAlign = "center"),
                                ...
                                p.plugins.register({
                                    beforeInit: function (t) {
                                        ...
                                        e && ((t.titleBlock = new p.Title({ ctx: t.chart.ctx, options: e, chart: t })), p.layoutService.addBox(t, t.titleBlock));
                                    },
                                });
                        };
                    },
                            ...
                            (n.defaults.global.tooltips = {
                                ...
                                callbacks: {
                                    ...
                                    title: function (t, e) {
                                        ...
                                        if (0 < t.length) {
                                            var r = t[0];
                                            r.xLabel ? (i = r.xLabel) : 0 < a && r.index < a && (i = n[r.index]);
                                        }
                                        return i;
                                    },
                                    afterTitle: x.noop,
                                ...
                                (n.Tooltip = n.Element.extend({
                                    initialize: function () {
                                        ...
                                        x.extend(this, {
                                            _model: {
                                                ...
                                                _titleFontFamily: i(e.titleFontFamily, t.defaultFontFamily),
                                                ...
                                                _footerFontFamily: i(e.footerFontFamily, t.defaultFontFamily),
                                                _footerFontStyle: i(e.footerFontStyle, t.defaultFontStyle),
                                    ...
                                    getBody: function (t, i) {
                                        ...
                                        return (
                                            x.each(t, function (t) {
                                                ...
                                                o(e.before, a.beforeLabel.call(n, t, i)), o(e.lines, a.label.call(n, t, i)), o(e.after, a.afterLabel.call(n, t, i)), r.push(e);
                                            }),
                                            r
                                        );
                                    },
                                        ...
                                        if (c.length) {
                                            ...
                                            var g = [],
                                                p = (function (t) {
                                                    ...
                                                    return { x: Math.round(s / n.length), y: Math.round(l / n.length) };
                                                })(c),
                                                m = [];
                                            for (e = 0, i = c.length; e < i; ++e)
                                                m.push(
                                                    ...
                                                    (o = n._index),
                                                    (s = n._datasetIndex),
                                                    { xLabel: a ? a.getLabelForIndex(o, s) : "", yLabel: r ? r.getLabelForIndex(o, s) : "", index: o, datasetIndex: s })
                                                );
                                            ...
                                            l.determineAlignment(v), x.extend(d, l.getBackgroundPoint(d, v));
                                    ...
                                    getTooltipSize: function (t) {
                                        ...
                                        return (
                                            (e.font = x.fontString(s, t._titleFontStyle, t._titleFontFamily)),
                                            x.each(t.title, c),
                                            (e.font = x.fontString(l, t._bodyFontStyle, t._bodyFontFamily)),
                                            x.each(t.beforeBody.concat(t.afterBody), c),
                                            (d = 1 < n.length ? l + 2 : 0),
                                            x.each(n, function (t) {
                                                x.each(t.before, c), x.each(t.lines, c), x.each(t.after, c);
                                            }),
                                            (d = 0),
                                            (e.font = x.fontString(u, t._footerFontStyle, t._footerFontFamily)),
                                            x.each(t.footer, c),
                                    ...
                                    determineAlignment: function (e) {
                                        ...
                                        o.y < e.height ? (o.yAlign = "top") : o.y > s.height - e.height && (o.yAlign = "bottom");
                                        ...
                                        (i =
                                            ...
                                            t(o.x) ? ((o.xAlign = "left"), n(o.x) && ((o.xAlign = "center"), (o.yAlign = r(o.y)))) : i(o.x) && ((o.xAlign = "right"), a(o.x) && ((o.xAlign = "center"), (o.yAlign = r(o.y))));
                                    },
                                    getBackgroundPoint: function (t, e) {
                                        var i = { x: t.x, y: t.y },
                                            ...
                                            u = r + a;
                                        return (
                                            "right" === o ? (i.x -= e.width) : "center" === o && (i.x -= e.width / 2),
                                            "top" === s ? (i.y += l) : (i.y -= "bottom" === s ? e.height + l : e.height / 2),
                                            "center" === s ? ("left" === o ? (i.x += l) : "right" === o && (i.x -= l)) : "left" === o ? (i.x -= u) : "right" === o && (i.x += u),
                                            i
                                        );
                                    },
                                    drawCaret: function (t, e, i) {
                                        ...
                                        l =
                                            "center" === g
                                                ? ((r = ((a = "left" === f ? (n = p) - c : (n = p + v) + c), n)), (o = (s = m + y / 2) - c), s + c)
                                                : ((r = "left" === f ? (a = (n = p + h) + c) + c : "right" === f ? (a = (n = p + v - h) - c) - c : ((n = (a = p + v / 2) - c), a + c)), (s = "top" === g ? (o = m) - c : (o = m + y) + c), o);
                                        var b = x.color(u.backgroundColor);
                                        (d.fillStyle = b.alpha(i * b.alpha()).rgbString()), d.beginPath(), d.moveTo(n, o), d.lineTo(a, s), d.lineTo(r, l), d.closePath(), d.fill();
                                    },
                                    drawTitle: function (t, e, i, n) {
                                        ...
                                        if (a.length) {
                                            ...
                                            for (i.fillStyle = u.alpha(n * u.alpha()).rgbString(), i.font = x.fontString(s, e._titleFontStyle, e._titleFontFamily), r = 0, o = a.length; r < o; ++r)
                                                i.fillText(a[r], t.x, t.y), (t.y += s + l), r + 1 === a.length && (t.y += e.titleMarginBottom - l);
                                        }
                                    },
                                    drawBody: function (i, n, a, r) {
                                        ...
                                        (a.fillStyle = l), (a.font = x.fontString(o, n._bodyFontStyle, n._bodyFontFamily));
                                        var u = 0,
                                            d = function (t) {
                                            ...
                                            x.each(t, function (t, e) {
                                                x.each(t.before, d),
                                                    x.each(t.lines, function (t) {
                                                        c &&
                                                            ((a.fillStyle = x.color(n.legendColorBackground).alpha(r).rgbaString()),
                                                            a.fillRect(i.x, i.y, o, o),
                                                            (a.strokeStyle = x.color(n.labelColors[e].borderColor).alpha(r).rgbaString()),
                                                            a.strokeRect(i.x, i.y, o, o),
                                                            (a.fillStyle = x.color(n.labelColors[e].backgroundColor).alpha(r).rgbaString()),
                                    ...
                                    drawFooter: function (e, i, n, t) {
                                        var a = i.footer;
                                        if (a.length) {
                                            (e.y += i.footerMarginTop), (n.textAlign = i._footerAlign), (n.textBaseline = "top");
                                            var r = x.color(i.footerFontColor);
                                            (n.fillStyle = r.alpha(t * r.alpha()).rgbString()),
                                                (n.font = x.fontString(i.footerFontSize, i._footerFontStyle, i._footerFontFamily)),
                                                x.each(a, function (t) {
                                        ...
                                        if (0 !== e.opacity) {
                                            ...
                                            if (this._options.enabled) {
                                                ...
                                                (t.fillStyle = r.alpha(a * r.alpha()).rgbString()),
                                                    x.drawRoundedRectangle(t, n.x, n.y, i.width, i.height, e.cornerRadius),
                                                    t.fill(),
                            ...
                            (e.elements.arc = { backgroundColor: e.defaultColor, borderColor: "#fff", borderWidth: 2 }),
                                (t.elements.Arc = t.Element.extend({
                                    ...
                                    inRange: function (t, e) {
                                        var i = this._view;
                                        if (i) {
                                            for (var n = d.getAngleFromPoint(i, { x: t, y: e }), a = n.angle, r = n.distance, o = i.startAngle, s = i.endAngle; s < o; ) s += 2 * Math.PI;
                                            for (; s < a; ) a -= 2 * Math.PI;
                                            for (; a < o; ) a += 2 * Math.PI;
                                            var l = o <= a && a <= s,
                                    ...
                                    draw: function () {
                                        ...
                                        function r(t, e) {
                                            ...
                                            !0 === e._view.steppedLine
                                                ? (a.lineTo(e._view.x, t._view.y), a.lineTo(e._view.x, e._view.y))
                                                : 0 === e._view.tension
                                                ? a.lineTo(i.x, i.y)
                                        ...
                                        if ((n && d.length && d.push(d[0]), d.length && t.fill)) {
                                            for (a.beginPath(), o = 0; o < d.length; ++o)
                                                (s = d[o]),
                                                    ...
                                                    (u = s._view),
                                                    0 === o
                                                        ? (n ? a.moveTo(i.x, i.y) : a.moveTo(u.x, i), u.skip || ((c = o), a.lineTo(u.x, u.y)))
                                                        : ((l = -1 === c ? l : d[c]),
                                                          u.skip
                                                              ? e || c !== o - 1 || (n ? a.lineTo(i.x, i.y) : a.lineTo(l._view.x, i))
                                                              : (c !== o - 1 ? (e && -1 !== c ? r(l, s) : (n || a.lineTo(u.x, i), a.lineTo(u.x, u.y))) : r(l, s), (c = o)));
                                            n || a.lineTo(d[c]._view.x, i), (a.fillStyle = t.backgroundColor || g.defaultColor), a.closePath(), a.fill();
                                        }
                                        var h = g.elements.line;
                                        for (
                                            a.lineCap = t.borderCapStyle || h.borderCapStyle,
                                                a.setLineDash && a.setLineDash(t.borderDash || h.borderDash),
                                                a.lineDashOffset = t.borderDashOffset || h.borderDashOffset,
                                            ...
                                            (s = d[o]),
                                                (l = f.previousItem(d, o)),
                                                (u = s._view),
                                                0 === o ? u.skip || (a.moveTo(u.x, u.y), (c = o)) : ((l = -1 === c ? l : d[c]), u.skip || ((c !== o - 1 && !e) || -1 === c ? a.moveTo(u.x, u.y) : r(l, s), (c = o)));
                                        a.stroke(), a.restore();
                                    },
                                }));
                        };
                    ...
                    function (t, e, i) {
                        ...
                        e.exports = function (o) {
                            var s = o.helpers,
                                l = o.defaults.global,
                                u = l.defaultColor;
                            (l.elements.point = { radius: 3, pointStyle: "circle", backgroundColor: u, borderWidth: 1, borderColor: u, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 }),
                                (o.elements.Point = o.Element.extend({
                                    ...
                                    draw: function () {
                                        ...
                                        t.skip ||
                                            ...
                                            (e.lineWidth = s.getValueOrDefault(t.borderWidth, l.elements.point.borderWidth)),
                                ...
                                e = t.Scale.extend({
                                    ...
                                    getPixelForValue: function (t, e, i, n) {
                                        ...
                                        if (a.isHorizontal()) {
                                            ...
                                            return a.options.gridLines.offsetGridLines && n && (l += s / 2), a.left + Math.round(l);
                                        }
                                        var u = (a.height - (a.paddingTop + a.paddingBottom)) / r,
                                            d = u * (e - a.minIndex) + a.paddingTop;
                                        return a.options.gridLines.offsetGridLines && n && (d += u / 2), a.top + Math.round(d);
                                    },
                                    getPixelForTick: function (t, e) {
                                    ...
                                    getValueForPixel: function (t) {
                                        var e = this,
                                            ...
                                            n = e.isHorizontal(),
                                            a = (n ? e.width - (e.paddingLeft + e.paddingRight) : e.height - (e.paddingTop + e.paddingBottom)) / i;
                                        return (t -= n ? e.left : e.top), e.options.gridLines.offsetGridLines && (t -= a / 2), (t -= n ? e.paddingLeft : e.paddingTop) <= 0 ? 0 : Math.round(t / a);
                                    },
                                    getBasePixel: function () {
                                        return this.bottom;
                                    },
                                ...
                                e = n.LinearScaleBase.extend({
                                    determineDataLimits: function () {
                                        ...
                                        if (((o.min = null), (o.max = null), s.stacked)) {
                                            ...
                                            d.each(t, function (t, e) {
                                                ...
                                                void 0 === u[n.type] && (u[n.type] = { positiveValues: [], negativeValues: [] });
                                                ...
                                                i.isDatasetVisible(e) &&
                                                    ...
                                                    d.each(t.data, function (t, e) {
                                                        ...
                                                        isNaN(i) || n.data[e].hidden || ((a[e] = a[e] || 0), (r[e] = r[e] || 0), s.relativePoints ? (a[e] = 100) : i < 0 ? (!0, (r[e] += i)) : (!0, (a[e] += i)));
                                                    });
                                            }),
                                                d.each(u, function (t) {
                                    ...
                                    getTickLimit: function () {
                                        ...
                                        if (this.isHorizontal()) t = Math.min(e.maxTicksLimit ? e.maxTicksLimit : 11, Math.ceil(this.width / 50));
                                            ...
                                            var i = d.getValueOrDefault(e.fontSize, n.defaults.global.defaultFontSize);
                                    ...
                                    getPixelForValue: function (t) {
                                        ...
                                        return n.isHorizontal()
                                            ? ((i = n.width - (a + n.paddingRight)), (e = n.left + (i / l) * (s - o)), Math.round(e + a))
                                            : ((i = n.height - (n.paddingTop + r)), (e = n.bottom - r - (i / l) * (s - o)), Math.round(e));
                                    },
                                    getValueForPixel: function (t) {
                                        var e = this,
                                            i = e.isHorizontal(),
                                            n = e.paddingLeft,
                                            a = e.paddingBottom,
                                            r = i ? e.width - (n + e.paddingRight) : e.height - (e.paddingTop + a),
                            ...
                            t.LinearScaleBase = t.Scale.extend({
                                ...
                                buildTicks: function () {
                                    var t,
                                        ...
                                        o = e.getTickLimit();
                                    if (((o = Math.max(2, o)), (a.fixedStepSize && 0 < a.fixedStepSize) || (a.stepSize && 0 < a.stepSize))) t = r(a.fixedStepSize, a.stepSize);
                                    else {
                                    ...
                                    var l = Math.floor(e.min / t) * t,
                                        ...
                                        d = (u - l) / t;
                                    (d = h.almostEquals(d, Math.round(d), t / 1e3) ? Math.round(d) : Math.ceil(d)), n.push(void 0 !== a.min ? a.min : l);
                                    for (var c = 1; c < d; ++c) n.push(l + c * t);
                                    n.push(void 0 !== a.max ? a.max : u),
                                        e.handleDirectionalChanges(),
                                        (e.max = h.max(n)),
                                        (e.min = h.min(n)),
                                        a.reverse ? (n.reverse(), (e.start = e.max), (e.end = e.min)) : ((e.start = e.min), (e.end = e.max));
                                },
                                convertTicksToLabels: function () {
                                ...
                                e = {
                                    ...
                                    ticks: {
                                        callback: function (t, e, i) {
                                            ...
                                            return 1 === n || 2 === n || 5 === n || 0 === e || e === i.length - 1 ? t.toExponential() : "";
                                        },
                                    },
                                },
                                i = t.Scale.extend({
                                    determineDataLimits: function () {
                                            ...
                                            d.each(e, function (t, e) {
                                                ...
                                                i.isDatasetVisible(e) &&
                                                    ...
                                                    d.each(t.data, function (t, e) {
                                                        var i = l[a.type],
                                                            n = +r.getRightValue(t);
                                                        isNaN(n) || a.data[e].hidden || ((i[e] = i[e] || 0), o.relativePoints ? (i[e] = 100) : (i[e] += n));
                                                    }));
                                            }),
                                                d.each(l, function (t) {
                                                    var e = d.min(t),
                                        ...
                                        (r.min = n(t.min, r.min)),
                                            (r.max = n(t.max, r.max)),
                                            r.min === r.max && (0 !== r.min && null !== r.min ? ((r.min = Math.pow(10, Math.floor(d.log10(r.min)) - 1)), (r.max = Math.pow(10, Math.floor(d.log10(r.max)) + 1))) : ((r.min = 1), (r.max = 10)));
                                    },
                                    buildTicks: function () {
                                        for (var t = this, e = t.options.ticks, i = d.getValueOrDefault, n = (t.ticks = []), a = i(e.min, Math.pow(10, Math.floor(d.log10(t.min)))); a < t.max; ) {
                                            n.push(a);
                                        ...
                                        var s = i(e.max, a);
                                        n.push(s), t.isHorizontal() || n.reverse(), (t.max = d.max(n)), (t.min = d.min(n)), e.reverse ? (n.reverse(), (t.start = t.max), (t.end = t.min)) : ((t.start = t.min), (t.end = t.max));
                                    },
                                    convertTicksToLabels: function () {
                                    ...
                                    getPixelForValue: function (t) {
                                        ...
                                        return (
                                            n.isHorizontal()
                                                ? 0 === r
                                                    ? (i = n.left + u)
                                                    : ((e = n.width - (u + n.paddingRight)), (i = n.left + (e / o) * (d.log10(r) - d.log10(a))), (i += u))
                                                : (i = 0 === r ? n.top + s : ((e = n.height - (s + l)), n.bottom - l - (e / o) * (d.log10(r) - d.log10(a)))),
                                            i
                                        );
                                    },
                                    getValueForPixel: function (t) {
                                        ...
                                        return i.isHorizontal()
                                            ? ((e = i.width - (i.paddingLeft + i.paddingRight)), i.start * Math.pow(10, ((t - i.left - i.paddingLeft) * n) / e))
                                            : ((e = i.height - (i.paddingTop + i.paddingBottom)), Math.pow(10, ((i.bottom - i.paddingBottom - t) * n) / e) / i.start);
                                    },
                                });
                                ...
                                e = t.LinearScaleBase.extend({
                                    ...
                                    fit: function () {
                                        var t,
                                            ...
                                            p = S.getValueOrDefault(h.fontFamily, _.defaultFontFamily),
                                        ...
                                        for (this.ctx.font = m, e = 0; e < this.getValueCount(); e++) {
                                            ...
                                            0 === x || 180 === x
                                                ? ((n = i / 2), t.x + n > y && ((y = t.x + n), (a = e)), t.x - n < b && ((b = t.x - n), (o = e)))
                                                : x < 180
                                                ? t.x + i > y && ((y = t.x + i), (a = e))
                                                : t.x - i < b && ((b = t.x - i), (o = e));
                                        }
                                    ...
                                    draw: function () {
                                        ...
                                        if (u.display) {
                                            ...
                                            if (
                                                (S.each(l.ticks, function (t, e) {
                                                    if (0 < e || u.reverse) {
                                                        var i = l.getDistanceFromCenterForValue(l.ticksAsNumbers[e]),
                                                            n = l.yCenter - i;
                                                        if (d.display && 0 !== e)
                                                            if (((f.strokeStyle = S.getValueAtIndexOrDefault(d.color, e - 1)), (f.lineWidth = S.getValueAtIndexOrDefault(d.lineWidth, e - 1)), u.lineArc))
                                                                f.beginPath(), f.arc(l.xCenter, l.yCenter, i, 0, 2 * Math.PI), f.closePath(), f.stroke();
                                                            else {
                                                                f.beginPath();
                                                                for (var a = 0; a < l.getValueCount(); a++) {
                                                                    var r = l.getPointPosition(a, i);
                                                                    0 === a ? f.moveTo(r.x, r.y) : f.lineTo(r.x, r.y);
                                                                }
                                                        ...
                                                        if (c.display) {
                                                            ...
                                                            if (((f.font = p), c.showLabelBackdrop)) {
                                                                ...
                                                                (f.fillStyle = c.backdropColor), f.fillRect(l.xCenter - s / 2 - c.backdropPaddingX, n - g / 2 - c.backdropPaddingY, s + 2 * c.backdropPaddingX, g + 2 * c.backdropPaddingY);
                                                            }
                                                            (f.textAlign = "center"), (f.textBaseline = "middle"), (f.fillStyle = o), f.fillText(t, l.xCenter, n);
                                                        }
                                                    }
                                                }),
                                                !u.lineArc)
                                                ...
                                                for (
                                                    var a = l.getDistanceFromCenterForValue(u.reverse ? l.min : l.max),
                                                    ...
                                                    if (t.display) {
                                                        ...
                                                        f.beginPath(), f.moveTo(l.xCenter, l.yCenter), f.lineTo(y.x, y.y), f.stroke(), f.closePath();
                                                    }
                                                    var b = l.getPointPosition(v, a + 5),
                                                        x = h(e.fontColor, _.defaultFontColor);
                                                    (f.font = m), (f.fillStyle = x);
                                                    var w = l.pointLabels,
                                                        k = ((360 * (this.getIndexAngle(v) + Math.PI / 2)) / (2 * Math.PI)) % 360;
                                                    (f.textAlign = 0 === k || 180 === k ? "center" : k < 180 ? "left" : "right"),
                                                        (f.textBaseline = 90 === k || 270 === k ? "middle" : 270 < k || k < 90 ? "bottom" : "top"),
                                ...
                                var x = b.helpers,
                                    ...
                                    t = b.Scale.extend({
                                        ...
                                        getLabelMoment: function (t, e) {
                                            return void 0 !== this.labelMoments[t] ? this.labelMoments[t][e] : null;
                                        },
                                        ...
                                        determineDataLimits: function () {
                                            ...
                                            a.chart.data.labels && 0 < a.chart.data.labels.length
                                                ? (x.each(
                                                      ...
                                                      function (t) {
                                                          var e = a.parseTime(t);
                                                          e.isValid() && (a.options.time.round && e.startOf(a.options.time.round), r.push(e));
                                                      },
                                                      a
                                                  ),
                                                        ...
                                                        "object" == typeof t.data[0] && null !== t.data[0]
                                                            ? x.each(
                                                                  ...
                                                                  function (t) {
                                                                      ...
                                                                      e.isValid() &&
                                                                          (a.options.time.round && e.startOf(a.options.time.round),
                                                                          i.push(e),
                                                                          n && ((a.firstTick = null !== a.firstTick ? u.min(a.firstTick, e) : e), (a.lastTick = null !== a.lastTick ? u.max(a.lastTick, e) : e)));
                                                                  },
                                                                  a
                                                              )
                                                            : (i = r),
                                                ...
                                                a.options.time.min && (a.firstTick = a.parseTime(a.options.time.min)),
                                                a.options.time.max && (a.lastTick = a.parseTime(a.options.time.max)),
                                        ...
                                        buildTicks: function () {
                                            ...
                                            n.ctx.save();
                                            var t,
                                                e = x.getValueOrDefault(n.options.ticks.fontSize, b.defaults.global.defaultFontSize),
                                                i = x.getValueOrDefault(n.options.ticks.fontStyle, b.defaults.global.defaultFontStyle),
                                                a = x.getValueOrDefault(n.options.ticks.fontFamily, b.defaults.global.defaultFontFamily),
                                                r = x.fontString(e, i, a);
                                            if (((n.ctx.font = r), (n.ticks = []), (n.unitScale = 1), (n.scaleSizeInUnits = 0), n.options.time.unit))
                                                (n.tickUnit = n.options.time.unit || "day"),
                                                    ...
                                                    (n.unitScale = x.getValueOrDefault(n.options.time.unitStepSize, 1));
                                            else {
                                                var o = n.isHorizontal() ? n.width - (n.paddingLeft + n.paddingRight) : n.height - (n.paddingTop + n.paddingBottom),
                                                    s = n.tickFormatFunction(n.firstTick, 0, []),
                                                    l = n.ctx.measureText(s).width,
                                                    u = o / (l = l * Math.cos(x.toRadians(n.options.ticks.maxRotation)) + e * Math.sin(x.toRadians(n.options.ticks.maxRotation)));
                                                ...
                                                for (var d = 0, c = w.units[d]; d < w.units.length; ) {
                                                    if (((n.unitScale = 1), x.isArray(c.steps) && Math.ceil(n.scaleSizeInUnits / u) < x.max(c.steps))) {
                                                        for (var h = 0; h < c.steps.length; ++h)
                                                            if (c.steps[h] >= Math.ceil(n.scaleSizeInUnits / u)) {
                                                                n.unitScale = x.getValueOrDefault(n.options.time.unitStepSize, c.steps[h]);
                                                                break;
                                                            }
                                                        break;
                                                    }
                                                    if (!1 === c.maxStep || Math.ceil(n.scaleSizeInUnits / u) < c.maxStep) {
                                                        n.unitScale = x.getValueOrDefault(n.options.time.unitStepSize, Math.ceil(n.scaleSizeInUnits / u));
                                                        break;
                                                    }
                                                    (c = w.units[++d]), (n.tickUnit = c.name);
                                                    var f = n.firstTick.diff(n.getMomentStartOf(n.firstTick), n.tickUnit, !0),
                                                        g = n.getMomentStartOf(n.lastTick.clone().add(1, n.tickUnit)).diff(n.lastTick, n.tickUnit, !0);
                                                    (n.scaleSizeInUnits = n.lastTick.diff(n.firstTick, n.tickUnit, !0) + f + g), (n.displayFormat = n.options.time.displayFormats[c.name]);
                                                }
                                            }
                                            if (((t = n.options.time.min ? n.getMomentStartOf(n.firstTick) : ((n.firstTick = n.getMomentStartOf(n.firstTick)), n.firstTick)), !n.options.time.max)) {
                                                var p = n.getMomentStartOf(n.lastTick),
                                                    m = p.diff(n.lastTick, n.tickUnit, !0);
                                                m < 0 ? (n.lastTick = n.getMomentStartOf(n.lastTick.add(1, n.tickUnit))) : 0 <= m && (n.lastTick = p), (n.scaleSizeInUnits = n.lastTick.diff(n.firstTick, n.tickUnit, !0));
                                            }
                                            ...
                                            for (var v = 1; v <= n.scaleSizeInUnits; ++v) {
                                                ...
                                                if (n.options.time.max && 0 <= y.diff(n.lastTick, n.tickUnit, !0)) break;
                                        ...
                                        getLabelForIndex: function (t, e) {
                                            ...
                                            return (
                                                "object" == typeof this.chart.data.datasets[e].data[0] && (i = this.getRightValue(this.chart.data.datasets[e].data[t])),
                                        ...
                                        getPixelForValue: function (t, e, i) {
                                            ...
                                            var a = t && t.isValid && t.isValid() ? t : n.getLabelMoment(i, e);
                                            if (a) {
                                                var r = a.diff(n.firstTick, n.tickUnit, !0),
                                                    o = 0 !== r ? r / n.scaleSizeInUnits : r;
                                                if (n.isHorizontal()) {
                                                    var s = (n.width - (n.paddingLeft + n.paddingRight)) * o + n.paddingLeft;
                                                    return n.left + Math.round(s);
                                                }
                                                var l = (n.height - (n.paddingTop + n.paddingBottom)) * o + n.paddingTop;
                                        ...
                                        getValueForPixel: function (t) {
                                            ...
                                            return (n *= e.scaleSizeInUnits), e.firstTick.clone().add(u.duration(n, e.tickUnit).asSeconds(), "seconds");
                                        },
                                        parseTime: function (t) {
                                            return "string" == typeof this.options.time.parser
                                                ...
                                                ? (console.warn("options.time.format is deprecated and replaced by options.time.parser. See http://nnnick.github.io/Chart.js/docs-v2/#scales-time-scale"), this.options.time.format(t))
