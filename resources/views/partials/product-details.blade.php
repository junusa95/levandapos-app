        ...
        <div class="row" style="background-color: #f9f6f2;">    
            <div class="col-md-12">
                ...
                <div class="navbar-nav right-navbar r-navbar">        
                    <div class="dropdown pro-actions" style="z-index: 9 !important;">
                        ...
                        <input type="hidden" name="sid" value="<?php echo $data['shop']->id; ?>">            
                        <input type="hidden" name="pname" value="">
                        <input type="hidden" name="sname" value="<?php echo $data['shop']->name; ?>">
                        <input type="hidden" name="shop_product" value="">
                        <ul class="dropdown-menu user-menu py-0" aria-labelledby="dropdownMenuButton" style="margin-top:0px;border-radius:5px">
                            ...
                            <a class="dropdown-item bg-warning text-dark remove-from-shop" product="" name="" shop="<?php echo $data['shop']->id; ?>" href="#"><i class="fa fa-times"></i> <?php echo $_GET['remove-from-shop']; ?></a>
                            @endif
            ...
            <div class="col-md-6 col-7 px-0 s-desc">
                <div class="body">
                    ...
                    <p class="mb-0 <?php echo $display_none; ?>">
                        <small><?php echo $_GET['category']; ?>: <b class="pcname">-</b></small> 
                    </p>
                    <?php 
            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="row year-summ">
                    ...
                    <div class="col-7 col-sm-5 xl-turquoise">
                        <div class="p-3">                                  
                            <h4 class="profit-s"></h4>
                            <span><?php echo $_GET['profit-on-sales']; ?></span>
                        </div>
                    </div>
                    @endif
                    <div class="col-5 col-sm-7">
                        <div class="row">
                            <div class="col-12 col-sm-6 xl-slategray">
                                <div class="p-3">                                  
                                    <h4 class="q-in"></h4>
                                    <span><?php echo $_GET['quantity-in']; ?></span>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 xl-salmon">
...
<div class="col-md-12 mt-3">
    <ul class="nav nav-tabs-new2">
        ...
        <li class="nav-item pro-sales-tab"><a class="nav-link" data-toggle="tab" href="#Pro-Sale"><?php echo $_GET['product-sales']; ?></a></li>
    </ul>
    <div class="tab-content" style="padding-top: 0px;">
        ...
        <div class="tab-pane render-product-sales" id="Pro-Sale">
            ...
            <div class="row pt-3 pb-2 psales-form" style="background:#f4f7f6">
                <input type="hidden" name="check-pro-sales" value="0">
