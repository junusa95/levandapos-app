            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">      
                            <div class="header">
                                <h2><b>Received Transfers:</b></h2><hr>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.transfer-items', function(e) {
        ...
        $.get('/transfer-items/'+tno+'/shop/<?php echo $sid; ?>', function(data){
    ...
    $(document).on('click', '.edit-transfer', function(e) {
        ...
        $.get('/edit-transfer/'+tno, function(data){
            if (data.status == "success") {
                window.location = '/cashier/<?php echo $sid; ?>/transfer-form';
            } else {
