        ...
        <div id="left-sidebar" class="sidebar">
            <div class="sidebar-scroll">
                <div class="user-account">
                    ...
                    <div class="dropdown">
                        <span>Welcome,</span>
                        <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown"><strong>Mr. Hamis Yenga</strong></a>
                    ...
                    <div class="tab-pane active" id="menu">
                        <nav class="sidebar-nav">
                            <ul class="main-menu metismenu">
                                ...
                                <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-user-follow"></i><span>Users</span> </a>
                                    <ul>
                                ...
                                <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-user"></i><span>Customers</span> </a>
                                    <ul>
                                ...
                                <li><a href="app-appointment.html"><i class="icon-calendar"></i>Measurements</a></li>
                                <li><a href="app-taskboard.html"><i class="icon-list"></i>Expenses</a></li>
                                <li><a href="app-inbox.html"><i class="icon-home"></i>Categories</a></li>
                                <li><a href="app-chat.html"><i class="icon-bubbles"></i>Variations</a></li>
                                <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-wallet"></i><span>Products</span> </a>
                                    <ul>
                                        <li><a href="payments.html">Payments</a></li>
                                        <li><a href="payments-add.html">Add Payment</a></li>
                                    </ul>
                                </li>
                                <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-layers"></i><span>Stores</span> </a>
                                    <ul>
                                        <li><a href="depa-add.html">Add</a></li>
                                        <li><a href="depa-all.html">All Departments</a></li>
                                    </ul>
                                </li>
                                <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-layers"></i><span>Shops</span> </a>
                                    <ul>
                                        <li><a href="depa-add.html">Add</a></li>
                                        <li><a href="depa-all.html">All Departments</a></li>
                                    </ul>
                                </li>
                                <li><a href="our-centres.html"><i class="icon-pointer"></i>Reports</a></li>
                            </ul>
                        </nav>
                    </div>
